...
import org.jetbrains.kotlinx.dataframe.util.INSTANT
import org.jetbrains.kotlinx.dataframe.util.LOCAL_DATE
import org.jetbrains.kotlinx.dataframe.util.LOCAL_DATE_TIME
import org.jetbrains.kotlinx.dataframe.util.LOCAL_TIME
...
class ParseTests {
    ...
    fun parseDate() {
        ...
        try {
            ...
            parsed.type() shouldBe LOCAL_DATE
            with(parsed[0]) {
    ...
    fun parseTime() {
        ...
        parsed.type() shouldBe LOCAL_TIME
        with(parsed[0]) {
            hour shouldBe 13
            minute shouldBe 5
            second shouldBe 30
    ...
    fun `parse date without formatter`() {
        ...
        casted[time].type() shouldBe LOCAL_DATE
    }
    ...
    @Test
    fun `parse instant`() {
        columnOf("2022-01-23T04:29:40Z").parse().type shouldBe INSTANT
        columnOf("2022-01-23T04:29:40+01:00").parse().type shouldBe INSTANT

        columnOf("2022-01-23T04:29:40").parse().type shouldBe LOCAL_DATE_TIME
    }
