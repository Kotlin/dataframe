...
public interface ColumnWithPath<out T> : DataColumn<T> {
    ...
    /**
     * Casts this column to a [ColumnGroup] and returns a column with the specified [accessor] or
    ...
    /**
     * Casts this column to a [ColumnGroup] and returns a column with the specified [name] or null
    ...
    /**
     * Casts this column to a [ColumnGroup] and returns a column with the specified [index] or null
     * if it can't be found.
     */
    ...
    /**
     * Returns all ("children") columns in this column if it's a group, else it returns an empty
     * list.
     */
...
public val <T> ColumnWithPath<T>.depth: Int
    get() = path.depth()
