...
/**
 * ## (Cols) Name (Contains / StartsWith / EndsWith)
...
public interface ColumnNameFiltersColumnsSelectionDsl {
    ...
    /**
     * ## (Cols) Name Contains
     * Returns a [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing all
     * columns from [this] having [text] in their name.
     *
     * This function operates solely on columns at the top-level.
     *
     * NOTE: For [column groups][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup],
     * `nameContains` is named `colsNameContains` to avoid confusion.
     *
     * This function is a shorthand for
     * [cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]` { `[text][text]`
     * `[in][String.contains]` it.`[name][org.jetbrains.kotlinx.dataframe.DataColumn.name]` }`.
     *
     * ### Check out:
     * [Grammar][org.jetbrains.kotlinx.dataframe.api.ColumnNameFiltersColumnsSelectionDsl.Grammar]
     *
     * #### For example:
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[nameContains][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.colsNameContains]`("my")
     * }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "someGroupCol".`[nameContains][kotlin.String.colsNameContains]`(`[Regex][Regex]`("my[a-zA-Z][a-zA-Z0-9]*"))
     * }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * Type::someGroupCol.`[nameContains][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.colsNameContains]`("my",
     * ignoreCase = true) }`
     *
     ...
     *   columns containing [text] in their name.
     * @see [nameEndsWith]
     * @see [nameStartsWith]
     */
     ...
     * ## (Cols) Name Contains
     * Returns a [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing all
     * columns from [this] having [regex] in their name.
     *
     * This function operates solely on columns at the top-level.
     *
     * NOTE: For [column groups][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup],
     ...
     *
     * This function is a shorthand for
     * [cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]` { `[regex][regex]`
     * `[in][String.contains]` it.`[name][org.jetbrains.kotlinx.dataframe.DataColumn.name]` }`.
     *
     * ### Check out:
     * [Grammar][org.jetbrains.kotlinx.dataframe.api.ColumnNameFiltersColumnsSelectionDsl.Grammar]
     ...
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing all
     *   columns containing [regex] in their name.
     * @see [nameEndsWith]
     * @see [nameStartsWith]
     */
     ...
     * Returns a [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing all
     * columns from [this] starting with [prefix] in their name.
     *
     * This function operates solely on columns at the top-level.
     *
     * NOTE: For [column groups][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup], the function
     * is named `colsNameStartsWith` to avoid confusion.
     *
     * This function is a shorthand for
     * [cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]` {
     * it.`[name][org.jetbrains.kotlinx.dataframe.DataColumn.name]`.`[startsWith][String.startsWith]`(`[prefix][prefix]`)
     * }`.
     *
     * ### Check out:
     * [Grammar][org.jetbrains.kotlinx.dataframe.api.ColumnNameFiltersColumnsSelectionDsl.Grammar]
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "someGroupCol".`[colsNameStartsWith][String.colsNameStartsWith]`("b") }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * Type::someGroupCol.`[colsNameStartsWith][SingleColumn.colsNameStartsWith]`("a", ignoreCase =
     * true) }`
     *
     * #### Examples for this overload:
     *
     ...
     *   `false`.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing all
     *   columns starting with [prefix] in their name.
     * @see [nameEndsWith]
     * @see [nameContains]
     */
    @Suppress("UNCHECKED_CAST")
     ...
     * ## (Cols) Name Ends With
     * Returns a [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing all
     * columns from [this] ending with [suffix] in their name.
     *
     * This function operates solely on columns at the top-level.
     *
     * NOTE: For [column groups][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup], the function
     * is named `colsNameEndsWith` to avoid confusion.
     *
     * This function is a shorthand for
     * [cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]` {
     * it.`[name][org.jetbrains.kotlinx.dataframe.DataColumn.name]`.`[endsWith][String.endsWith]`(`[suffix][suffix]`)
     * }`.
     *
     * ### Check out:
     * [Grammar][org.jetbrains.kotlinx.dataframe.api.ColumnNameFiltersColumnsSelectionDsl.Grammar]
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "someGroupCol".`[colsNameEndsWith][String.colsNameEndsWith]`("b") }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * Type::someGroupCol.`[colsNameEndsWith][SingleColumn.colsNameEndsWith]`("a", ignoreCase =
     * true) }`
     *
     * #### Examples for this overload:
     *
     ...
     *   `false`.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing all
     *   columns ending with [suffix] in their name.
     * @see [nameStartsWith]
     * @see [nameContains]
     */
    @Suppress("UNCHECKED_CAST")
