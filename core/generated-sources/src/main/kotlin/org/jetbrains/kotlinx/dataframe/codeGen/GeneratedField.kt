 ...
 */
public fun FieldType.isNullable(): Boolean = when (this) {
 ...
 * NOTE: for [FieldType.FrameFieldType], the `nullable` property indicates the nullability of the frame itself, not the type of the column.
 */
public fun FieldType.toNotNullable(): FieldType = if (isNullable()) {
    when (this) {
...
public fun BaseField.toNullable(): BaseField = if (fieldType.isNullable()) {
    this
} else {
    object : BaseField {
...
public fun BaseField.toNotNullable(): BaseField = if (fieldType.isNotNullable()) {
    this
} else {
    object : BaseField {
