...
public interface TakeColumnsSelectionDsl {
    ...
    /**
     * ## Take (Cols)
     * This takes the first [n] columns from [this] collecting the result into a
     ...
     *
     * NOTE: To avoid ambiguity, `take` is called `takeCols` when called on a
     ...
     * it.`[name][org.jetbrains.kotlinx.dataframe.DataColumn.name]` }.`[take][ColumnSet.take]`(5) }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[take][ColumnsSelectionDsl.take]`(1) }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * myColumnGroup.`[takeCols][SingleColumn.takeCols]`(2) }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "myColumnGroup".`[takeCols][String.takeCols]`(3) }`
     *
     ...
     * `[colsOf][SingleColumn.colsOf]`<`[String][String]`>().`[take][ColumnSet.take]`(2) }`
     *
     * `df.`[select][DataFrame.select]` { `[cols][ColumnsSelectionDsl.cols]` { ..
     * }.`[take][ColumnSet.take]`(2) }`
     *
     * @param [n] The number of columns to take.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the first
     *   [n] columns.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * DataSchemaType::myColumnGroup.`[takeCols][KProperty.takeCols]`(1) }`
     *
     * @param [n] The number of columns to take.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the first
     *   [n] columns.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * "pathTo"["myColumnGroup"].`[takeCols][ColumnPath.takeCols]`(1) }`
     *
     * @param [n] The number of columns to take.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the first
     *   [n] columns.
    ...
    /**
     * ## Take Last (Cols)
     * This takes the last [n] columns from [this] collecting the result into a
     * [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet].
     *
     * This function operates solely on columns at the top-level.
     *
     ...
     * receiver for these functions.
     *
     * NOTE: To avoid ambiguity, `takeLast` is called `takeLastCols` when called on a
     * [ColumnGroup][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup].
     *
     * ### Check out: [Grammar]
     *
     ...
     * }.`[takeLast][ColumnSet.takeLast]`(5) }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[takeLast][ColumnsSelectionDsl.takeLast]`(1) }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * myColumnGroup.`[takeLastCols][SingleColumn.takeLastCols]`(2) }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "myColumnGroup".`[takeLastCols][String.takeLastCols]`(3) }`
     *
     * #### Examples for this overload:
     *
     * @param [n] The number of columns to take.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * `[colsOf][SingleColumn.colsOf]`<`[String][String]`>().`[takeLast][ColumnSet.takeLast]`(2) }`
     *
     * `df.`[select][DataFrame.select]` { `[cols][ColumnsSelectionDsl.cols]` { ..
     * }.`[takeLast][ColumnSet.takeLast]`(2) }`
     *
     * @param [n] The number of columns to take.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the last
     *   [n] columns.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * Type::myColumnGroup.`[takeLastCols][SingleColumn.takeLastCols]`(1) }`
     *
     * `df.`[select][DataFrame.select]` {
     * DataSchemaType::myColumnGroup.`[takeLastCols][KProperty.takeLastCols]`(1) }`
     *
     * @param [n] The number of columns to take.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the last
     *   [n] columns.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * "pathTo"["myColumnGroup"].`[takeLastCols][ColumnPath.takeLastCols]`(1) }`
     *
     * @param [n] The number of columns to take.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the last
     *   [n] columns.
    ...
    /**
     * ## Take (Cols) While
     * This function takes the first columns from [this] adhering to the given [predicate]
     ...
     * receiver for these functions.
     *
     * NOTE: To avoid ambiguity, `takeWhile` is called `takeColsWhile` when called on a [String] or
     ...
     * `[`cols`][ColumnsSelectionDsl.cols]` { "my" `[`in`][String.contains]`
     * it.`[`name`][org.jetbrains.kotlinx.dataframe.DataColumn.name]`
     * }.`[`takeWhile`][ColumnSet.takeWhile]` { "my" `[`in`][String.contains]`
     * it.`[`name`][org.jetbrains.kotlinx.dataframe.DataColumn.name]` } }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * myColumnGroup.`[`takeWhile`][SingleColumn.takeColsWhile]` { it.`[`any`][ColumnWithPath.any]`
     * { it == "Alice" } } }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "myColumnGroup".`[`takeColsWhile`][String.takeColsWhile]` {
     ...
     *   columns adhering to the [predicate].
     */
    public fun <C> ColumnSet<C>.takeWhile(predicate: ColumnFilter<C>): ColumnSet<C> = transform {
     ...
     * #### Examples for this overload:
     *
     * `df.`[select][DataFrame.select]` { `[takeWhile][ColumnsSelectionDsl.takeWhile]` {
     * it.`[any][ColumnWithPath.any]` { it == "Alice" } } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to take.
     ...
     * #### Examples for this overload:
     *
     * `df.`[select][DataFrame.select]` { myColumnGroup.`[takeWhile][SingleColumn.takeColsWhile]` {
     * it.`[name][ColumnWithPath.name]`.`[startsWith][String.startsWith]`("my") } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to take.
     ...
     * #### Examples for this overload:
     *
     * `df.`[select][DataFrame.select]` { "myColumnGroup".`[takeColsWhile][String.takeColsWhile]` {
     * it.`[name][ColumnWithPath.name]`.`[startsWith][String.startsWith]`("my") } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to take.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * Type::myColumnGroup.`[takeColsWhile][SingleColumn.takeColsWhile]` {
     * it.`[name][ColumnWithPath.name]`.`[startsWith][String.startsWith]`("my") } }`
     *
     * `df.`[select][DataFrame.select]` {
     * DataSchemaType::myColumnGroup.`[takeColsWhile][KProperty.takeColsWhile]` {
     * it.`[any][ColumnWithPath.any]` { it == "Alice" } } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to take.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * "pathTo"["myColumnGroup"].`[takeColsWhile][ColumnPath.takeColsWhile]` {
     * it.`[name][ColumnWithPath.name]`.`[startsWith][String.startsWith]`("my") } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to take.
     ...
     * This function takes the last columns from [this] adhering to the given [predicate] collecting
     ...
     * receiver for these functions.
     *
     * NOTE: To avoid ambiguity, `takeLastWhile` is called `takeLastColsWhile` when called on a
     ...
     * `[`cols`][ColumnsSelectionDsl.cols]` { "my" `[`in`][String.contains]`
     * it.`[`name`][org.jetbrains.kotlinx.dataframe.DataColumn.name]`
     * }.`[`takeLastWhile`][ColumnSet.takeLastWhile]` { "my" `[`in`][String.contains]`
     * it.`[`name`][org.jetbrains.kotlinx.dataframe.DataColumn.name]` } }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * myColumnGroup.`[`takeLastWhile`][SingleColumn.takeLastColsWhile]` {
     * it.`[`any`][ColumnWithPath.any]` { it == "Alice" } } }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "myColumnGroup".`[`takeLastColsWhile`][String.takeLastColsWhile]` {
     * it.`[`kind`][ColumnWithPath.kind]`() ==
     * `[`ColumnKind.Value`][org.jetbrains.kotlinx.dataframe.columns.ColumnKind.Value]` } }`
     *
     * #### Examples for this overload:
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * `[colsOf][SingleColumn.colsOf]`<`[String][String]`>().`[takeLastWhile][ColumnSet.takeLastWhile]`
     * { it.`[any][ColumnWithPath.any]` { it == "Alice" } } }`
     *
     * `df.`[select][DataFrame.select]` { `[cols][ColumnsSelectionDsl.cols]` { ..
     * }.`[takeLastWhile][ColumnSet.takeLastWhile]` {
     * it.`[name][ColumnWithPath.name]`.`[startsWith][String.startsWith]`("my") } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to take.
     ...
     * #### Examples for this overload:
     *
     * `df.`[select][DataFrame.select]` { `[takeLastWhile][ColumnsSelectionDsl.takeLastWhile]` {
     * it.`[any][ColumnWithPath.any]` { it == "Alice" } } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to take.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * myColumnGroup.`[takeLastColsWhile][SingleColumn.takeLastColsWhile]` {
     * it.`[name][ColumnWithPath.name]`.`[startsWith][String.startsWith]`("my") } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to take.
     ...
     *   columns adhering to the [predicate].
     */
    public fun SingleColumn<DataRow<*>>.takeLastColsWhile(
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * Type::myColumnGroup.`[takeLastColsWhile][SingleColumn.takeLastColsWhile]` {
     * it.`[name][ColumnWithPath.name]`.`[startsWith][String.startsWith]`("my") } }`
     *
     * `df.`[select][DataFrame.select]` {
     * DataSchemaType::myColumnGroup.`[takeLastColsWhile][KProperty.takeLastColsWhile]` {
     * it.`[any][ColumnWithPath.any]` { it == "Alice" } } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to take.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * "pathTo"["myColumnGroup"].`[takeLastColsWhile][ColumnPath.takeLastColsWhile]` {
     * it.`[name][ColumnWithPath.name]`.`[startsWith][String.startsWith]`("my") } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to take.
