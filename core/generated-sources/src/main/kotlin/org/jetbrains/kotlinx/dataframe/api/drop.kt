...
public inline fun <T> DataColumn<T>.drop(predicate: Predicate<T>): DataColumn<T> = filter {
    !predicate(it)
}
...
public inline fun <T> DataFrame<T>.drop(predicate: RowFilter<T>): DataFrame<T> = filter {
    !predicate(it, it)
}
...
public interface DropColumnsSelectionDsl {
    ...
    /**
     * ## Drop (Cols)
     * This drops the first [n] columns from [this] collecting the result into a
     * [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet].
     *
     * This function operates solely on columns at the top-level.
     *
     * Any [Access APIs][org.jetbrains.kotlinx.dataframe.documentation.AccessApis] can be used as
     * receiver for these functions.
     *
     * NOTE: To avoid ambiguity, `drop` is called `dropCols` when called on a
     ...
     * `[cols][ColumnsSelectionDsl.cols]` { "my" `[in][String.contains]`
     * it.`[name][org.jetbrains.kotlinx.dataframe.DataColumn.name]` }.`[drop][ColumnSet.drop]`(5) }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[drop][ColumnsSelectionDsl.drop]`(1) }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * myColumnGroup.`[dropCols][SingleColumn.dropCols]`(2) }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "myColumnGroup".`[dropCols][String.dropCols]`(3) }`
     *
     * #### Examples for this overload:
     *
     * @param [n] The number of columns to drop.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the first
     *   [n] columns.
     */
     ...
     * #### Examples:
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]` { "my"
     * `[in][String.contains]` it.`[name][org.jetbrains.kotlinx.dataframe.DataColumn.name]`
     * }.`[drop][ColumnSet.drop]`(5) }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[drop][ColumnsSelectionDsl.drop]`(1) }`
     *
     ...
     * `[colsOf][SingleColumn.colsOf]`<`[String][String]`>().`[drop][ColumnSet.drop]`(2) }`
     *
     * `df.`[select][DataFrame.select]` { `[cols][ColumnsSelectionDsl.cols]` { ..
     * }.`[drop][ColumnSet.drop]`(2) }`
     *
     * @param [n] The number of columns to drop.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the first
     *   [n] columns.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * DataSchemaType::myColumnGroup.`[dropCols][KProperty.dropCols]`(1) }`
     *
     * @param [n] The number of columns to drop.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the first
     *   [n] columns.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * "pathTo"["myColumnGroup"].`[dropCols][ColumnPath.dropCols]`(1) }`
     *
     * @param [n] The number of columns to drop.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the first
     *   [n] columns.
    ...
    /**
     * ## Drop Last (Cols)
     * This drops the last [n] columns from [this] collecting the result into a
     * [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet].
     *
     * This function operates solely on columns at the top-level.
     *
     ...
     * receiver for these functions.
     *
     * NOTE: To avoid ambiguity, `dropLast` is called `dropLastCols` when called on a
     * [ColumnGroup][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup].
     *
     * ### Check out: [Grammar]
     *
     ...
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[cols][ColumnsSelectionDsl.cols]` { "my" `[in][String.contains]`
     * it.`[name][org.jetbrains.kotlinx.dataframe.DataColumn.name]`
     * }.`[dropLast][ColumnSet.dropLast]`(5) }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[dropLast][ColumnsSelectionDsl.dropLast]`(1) }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * myColumnGroup.`[dropLastCols][SingleColumn.dropLastCols]`(2) }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "myColumnGroup".`[dropLastCols][String.dropLastCols]`(3) }`
     *
     * #### Examples for this overload:
     *
     * @param [n] The number of columns to drop.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the last
     *   [n] columns.
     */
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * `[colsOf][SingleColumn.colsOf]`<`[String][String]`>().`[dropLast][ColumnSet.dropLast]`(2) }`
     *
     * `df.`[select][DataFrame.select]` { `[cols][ColumnsSelectionDsl.cols]` { ..
     * }.`[dropLast][ColumnSet.dropLast]`() }`
     *
     * @param [n] The number of columns to drop.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the last
     *   [n] columns.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * myColumnGroup.`[dropLastCols][SingleColumn.dropLastCols]`() }`
     *
     * @param [n] The number of columns to drop.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the last
     *   [n] columns.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * DataSchemaType::myColumnGroup.`[dropLastCols][KProperty.dropLastCols]`(1) }`
     *
     * @param [n] The number of columns to drop.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the last
     *   [n] columns.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * "pathTo"["myColumnGroup"].`[dropLastCols][ColumnPath.dropLastCols]`(1) }`
     *
     * @param [n] The number of columns to drop.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the last
     *   [n] columns.
    ...
    /**
     * ## Drop (Cols) While
     * This function drops the first columns from [this] adhering to the given [predicate]
     * collecting the result into a [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet].
     *
     * This function operates solely on columns at the top-level.
     *
     * Any [Access APIs][org.jetbrains.kotlinx.dataframe.documentation.AccessApis] can be used as
     * receiver for these functions.
     *
     * NOTE: To avoid ambiguity, `dropWhile` is called `dropColsWhile` when called on a [String] or
     * [ColumnPath][org.jetbrains.kotlinx.dataframe.columns.ColumnPath] resembling a
     * [ColumnGroup][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup].
     *
     * ### Check out: [Usage]
     *
     ...
     * `[`cols`][ColumnsSelectionDsl.cols]` { "my" `[`in`][String.contains]`
     * it.`[`name`][org.jetbrains.kotlinx.dataframe.DataColumn.name]`
     * }.`[`dropWhile`][ColumnSet.dropWhile]` { "my" `[`in`][String.contains]`
     * it.`[`name`][org.jetbrains.kotlinx.dataframe.DataColumn.name]` } }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * myColumnGroup.`[`dropWhile`][SingleColumn.dropColsWhile]` { it.`[`any`][ColumnWithPath.any]`
     * { it == "Alice" } } }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "myColumnGroup".`[`dropColsWhile`][String.dropColsWhile]` {
     * it.`[`kind`][ColumnWithPath.kind]`() ==
     * `[`ColumnKind.Value`][org.jetbrains.kotlinx.dataframe.columns.ColumnKind.Value]` } }`
     *
     * #### Examples for this overload:
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to drop.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the first
     *   columns adhering to the [predicate].
     */
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * `[colsOf][SingleColumn.colsOf]`<`[String][String]`>().`[dropWhile][ColumnSet.dropWhile]` {
     * it.`[any][ColumnWithPath.any]` { it == "Alice" } } }`
     *
     * `df.`[select][DataFrame.select]` { `[cols][ColumnsSelectionDsl.cols]` { ..
     * }.`[dropWhile][ColumnSet.dropWhile]` {
     * it.`[name][ColumnWithPath.name]`.`[startsWith][String.startsWith]`("my") } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to drop.
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing the first
     *   columns adhering to the [predicate].
     */
    public fun <C> ColumnSet<C>.dropWhile(predicate: ColumnFilter<C>): ColumnSet<C> = transform {
     ...
     * #### Examples for this overload:
     *
     * `df.`[select][DataFrame.select]` { `[dropWhile][ColumnsSelectionDsl.dropWhile]` {
     * it.`[any][ColumnWithPath.any]` { it == "Alice" } } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to drop.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * myColumnGroup.`[dropColsWhile][SingleColumn.dropColsWhile]` {
     * it.`[name][ColumnWithPath.name]`.`[startsWith][String.startsWith]`("my") } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to drop.
     ...
     * #### Examples for this overload:
     *
     * `df.`[select][DataFrame.select]` { "myColumnGroup".`[dropColsWhile][String.dropColsWhile]` {
     * it.`[name][ColumnWithPath.name]`.`[startsWith][String.startsWith]`("my") } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to drop.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * DataSchemaType::myColumnGroup.`[dropColsWhile][KProperty.dropColsWhile]` {
     * it.`[any][ColumnWithPath.any]` { it == "Alice" } } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to drop.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * "pathTo"["myColumnGroup"].`[dropColsWhile][ColumnPath.dropColsWhile]` {
     * it.`[name][ColumnWithPath.name]`.`[startsWith][String.startsWith]`("my") } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to drop.
     ...
     * This function drops the last columns from [this] adhering to the given [predicate] collecting
     ...
     * receiver for these functions.
     *
     * NOTE: To avoid ambiguity, `dropLastWhile` is called `dropLastColsWhile` when called on a
     * [String] or [ColumnPath][org.jetbrains.kotlinx.dataframe.columns.ColumnPath] resembling a
     * [ColumnGroup][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup].
     *
     * ### Check out: [Usage]
     *
     ...
     * `[`cols`][ColumnsSelectionDsl.cols]` { "my" `[`in`][String.contains]`
     * it.`[`name`][org.jetbrains.kotlinx.dataframe.DataColumn.name]`
     * }.`[`dropLastWhile`][ColumnSet.dropLastWhile]` { "my" `[`in`][String.contains]`
     * it.`[`name`][org.jetbrains.kotlinx.dataframe.DataColumn.name]` } }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * myColumnGroup.`[`dropLastWhile`][SingleColumn.dropLastColsWhile]` {
     * it.`[`any`][ColumnWithPath.any]` { it == "Alice" } } }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "myColumnGroup".`[`dropLastColsWhile`][String.dropLastColsWhile]` {
     * it.`[`kind`][ColumnWithPath.kind]`() ==
     * `[`ColumnKind.Value`][org.jetbrains.kotlinx.dataframe.columns.ColumnKind.Value]` } }`
     *
     * #### Examples for this overload:
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * `[colsOf][SingleColumn.colsOf]`<`[String][String]`>().`[dropLastWhile][ColumnSet.dropLastWhile]`
     * { it.`[any][ColumnWithPath.any]` { it == "Alice" } } }`
     *
     * `df.`[select][DataFrame.select]` { `[cols][ColumnsSelectionDsl.cols]` { ..
     * }.`[dropLastWhile][ColumnSet.dropLastWhile]` {
     * it.`[name][ColumnWithPath.name]`.`[startsWith][String.startsWith]`("my") } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to drop.
     ...
     * #### Examples for this overload:
     *
     * `df.`[select][DataFrame.select]` { `[dropLastWhile][ColumnsSelectionDsl.dropLastWhile]` {
     * it.`[any][ColumnWithPath.any]` { it == "Alice" } } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to drop.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * myColumnGroup.`[dropLastColsWhile][SingleColumn.dropLastColsWhile]` {
     * it.`[name][ColumnWithPath.name]`.`[startsWith][String.startsWith]`("my") } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to drop.
     ...
     *   columns adhering to the [predicate].
     */
    public fun SingleColumn<DataRow<*>>.dropLastColsWhile(
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * Type::myColumnGroup.`[dropLastColsWhile][SingleColumn.dropLastColsWhile]` {
     * it.`[name][ColumnWithPath.name]`.`[startsWith][String.startsWith]`("my") } }`
     *
     * `df.`[select][DataFrame.select]` {
     * DataSchemaType::myColumnGroup.`[dropLastColsWhile][KProperty.dropLastColsWhile]` {
     * it.`[any][ColumnWithPath.any]` { it == "Alice" } } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to drop.
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * "pathTo"["myColumnGroup"].`[dropLastColsWhile][ColumnPath.dropLastColsWhile]` {
     * it.`[name][ColumnWithPath.name]`.`[startsWith][String.startsWith]`("my") } }`
     *
     * @param [predicate] The [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] to
     *   control which columns to drop.
