...
public interface DataFrame<out T> : Aggregatable<T>, ColumnsContainer<T> {
     ...
     *
     * [AggregateDsl] allows to compute statistics on the columns of this [DataFrame] and store the
     * results as a new column using
     * [into][org.jetbrains.kotlinx.dataframe.aggregation.AggregateDsl.into].
     *
     * The resulting [DataRow] has the same structure as the original [DataFrame]; instead of the
     * groups, there are new columns of aggregated values created with
     * [into][org.jetbrains.kotlinx.dataframe.aggregation.AggregateDsl.into].
     *
     * You can use any of
     ...
     * resulting [DataRow] while preserving the original structure at higher levels.
     *
     * #### Example
     *
     * ```kotlin
