...
public interface ColsOfKindColumnsSelectionDsl {
     ...
     *
     * You can optionally use a [filter] to only include certain columns.
     * [colsOfKind][org.jetbrains.kotlinx.dataframe.api.ColsOfKindColumnsSelectionDsl.colsOfKind] can be called using any of the supported [APIs][`Access APIs`] (+ [ColumnPath][org.jetbrains.kotlinx.dataframe.columns.ColumnPath]).
     *
     * This function operates solely on columns at the top-level.
     *
