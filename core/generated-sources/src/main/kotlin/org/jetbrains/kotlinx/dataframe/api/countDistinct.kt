 ...
 * [See `countDistinct` on the documentation website.](https://kotlin.github.io/dataframe/countdistinct.html)
 *
...
/**
 * Returns number of distinct combinations of values in selected [columns] in this
 ...
 *
 * See also:
 * - [distinct][org.jetbrains.kotlinx.dataframe.DataFrame.distinct], which removes duplicate rows
 *   and returns a new [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame].
 * - [count][org.jetbrains.kotlinx.dataframe.DataFrame.count], which counts the number of rows
