...
/**
 * Implementation of [AggregatorAggregationHandler] which functions like a reducer: it takes a
 * sequence of values and returns a single value, which can be a completely different type.
 *
 * @param reducer This function actually does the reduction. Before it is called, nulls are filtered
 *   out. The type of the values is passed as [KType] to the reducer.
 * @param getReturnType This function must be supplied to give the return type of [reducer] given
 *   some input type and whether the input is empty.
