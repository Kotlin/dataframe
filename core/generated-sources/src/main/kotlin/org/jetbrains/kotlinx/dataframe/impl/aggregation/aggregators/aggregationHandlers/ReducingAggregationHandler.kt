...
/**
 * Implementation of [<code>AggregatorAggregationHandler</code>][AggregatorAggregationHandler] which functions like a reducer:
 ...
 *   Before it is called, nulls are filtered out. The type of the values is passed as [<code>KType</code>][KType] to the reducer.
