 ...
 * [See `remove` on the documentation website.](https://kotlin.github.io/dataframe/remove.html)
 */
 ...
 * ## The Remove Operation
 *
 * Removes the specified [columns][org.jetbrains.kotlinx.dataframe.columns] from the original
 * [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame] and returns a new
 * [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame] without them.
 *
 * This can include [column groups][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup] and nested
 * columns.
 *
 ...
 * #### For example:
 *
 * <code>`df`</code>`.`[remove][org.jetbrains.kotlinx.dataframe.api.remove]` { length
 * `[and][ColumnsSelectionDsl.and]` age }`
 *
 * <code>`df`</code>`.`[remove][org.jetbrains.kotlinx.dataframe.api.remove]` {
