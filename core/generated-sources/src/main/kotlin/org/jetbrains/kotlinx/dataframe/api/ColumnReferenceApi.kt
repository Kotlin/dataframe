...
internal val ColumnReference<*>.name: String
    get() = name()
...
@Deprecated(DEPRECATED_ACCESS_API, level = DeprecationLevel.ERROR)
public infix fun <C : Comparable<C>> ColumnReference<C>.gt(value: C): ColumnReference<Boolean> =
    map {
        it > value
    }

@Deprecated(DEPRECATED_ACCESS_API, level = DeprecationLevel.ERROR)
public infix fun <C : Comparable<C>> ColumnReference<C>.lt(value: C): ColumnReference<Boolean> =
    map {
        it < value
    }
...
@Deprecated(DEPRECATED_ACCESS_API, level = DeprecationLevel.ERROR)
public infix fun <C> ColumnReference<C>.neq(value: C): ColumnReference<Boolean> = map {
    it != value
}
