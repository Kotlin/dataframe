 ...
 * [See `group` on the documentation website.](https://kotlin.github.io/dataframe/ungroup.html)
 *
...
internal interface UngroupDocs {
     ...
     * #### For example:
     *
     * <code>`df`</code>`.`[ungroup][org.jetbrains.kotlinx.dataframe.api.ungroup]` { length
     * `[and][ColumnsSelectionDsl.and]` age }`
     *
     * <code>`df`</code>`.`[ungroup][org.jetbrains.kotlinx.dataframe.api.ungroup]` {
...
/**
 * Ungroups the specified [column groups][columns] within the
 * [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame], i.e., replaces each
 * [ColumnGroup][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup] with its nested columns.
 *
 * This can include nested column groups.
 *
 ...
 * ```
 *
 * @param [columns] The [Columns Selector][ColumnsSelector] used to select the column groups of this
 *   [DataFrame] to ungroup.
