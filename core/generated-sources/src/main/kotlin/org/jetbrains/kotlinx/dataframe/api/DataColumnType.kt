 ...
 *
 * If true, operations like [`min()`][org.jetbrains.kotlinx.dataframe.DataColumn.min],
 * [`max()`][org.jetbrains.kotlinx.dataframe.DataColumn.max],
 * [`median()`][org.jetbrains.kotlinx.dataframe.DataColumn.median], etc. will work.
 *
