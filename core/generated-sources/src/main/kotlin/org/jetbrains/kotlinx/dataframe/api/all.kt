...
public fun <C> DataColumn<C>.allNulls(): Boolean =
    size == 0 || type() == nullableNothingType || all { it == null }
...
public inline fun <T> DataFrame<T>.all(predicate: RowFilter<T>): Boolean =
    rows().all { predicate(it, it) }
...
public interface AllColumnsSelectionDsl<out _UNUSED> {
     ...
     * | `**`{
     * `**[`colSelector`][org.jetbrains.kotlinx.dataframe.documentation.DslGrammarTemplateColumnsSelectionDsl.DslGrammarTemplate.ColumnSelectorDef]**`
     * }`**` )`
     *
     * &nbsp;&nbsp;&nbsp;&nbsp;
     *
     ...
     * ## All (Cols)
     *
     * Creates a new [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] that contains
     * all columns from [this], the opposite of
     * [none][org.jetbrains.kotlinx.dataframe.api.NoneColumnsSelectionDsl.none].
     *
     * This makes the function equivalent to
     * [cols()][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols] without filter.
     *
     * This function operates solely on columns at the top-level.
     *
     * NOTE: For [column groups][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup], `all` is
     * named `allCols` instead to avoid confusion.
     *
     * ### Check out: [Grammar][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.Grammar]
     *
     * #### For example:
     * `df.`[move][org.jetbrains.kotlinx.dataframe.DataFrame.move]` {
     * `[all][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.all]`()
     * }.`[under][org.jetbrains.kotlinx.dataframe.api.MoveClause.under]`("info")`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * myGroup.`[allCols][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allCols]`() }`
     *
     * #### Examples for this overload:
     *
     * `df.`[select][DataFrame.select]` { `[cols][ColumnsSelectionDsl.cols]` { "a" in
     * `[name][ColumnWithPath.name]` }.`[all][ColumnSet.all]`() }`
     *
     * &nbsp;&nbsp;&nbsp;&nbsp;
     *
     ...
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     *   columns
     *
     ...
     * DataSchemaType::columnGroup.`[allCols][KProperty.allCols]`() }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     * ## All (Cols) After
     *
     * Creates a new [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] that contains a
     * subset of columns from [this], containing all columns after [column], excluding [column]
     * itself.
     *
     * [column] can be specified both relative to the current
     * [ColumnGroup][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup] or the outer scope and can
     * be referenced using any
     ...
     * &nbsp;&nbsp;&nbsp;&nbsp;
     *
     * NOTE: Using the `{}` overloads of these functions requires a
     * [ColumnSelector][org.jetbrains.kotlinx.dataframe.ColumnSelector] in the Plain DSL and on
     * [column groups][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup]. On
     * [ColumnSets][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] it requires a
     * [ColumnFilter][org.jetbrains.kotlinx.dataframe.ColumnFilter] instead.
     *
     * ### Check out: [Grammar][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.Grammar]
     *
     * #### For example:
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[allAfter][ColumnsSelectionDsl.allAfter]`("someColumn") }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[colGroup][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.colGroup]`(Type::myColGroup).`[allColsAfter][SingleColumn.allColsAfter]`(someColumn)
     * }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[colsOf][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.colsOf]`<`[Int][Int]`>().`[allAfter][ColumnSet.allAfter]`(Type::someColumn)
     * }`
     *
     * #### Examples for this overload:
     *
     ...
     *   All columns up to the specified column, including that column
     *
     * @param [column] The specified column after which all columns should be taken. This column can
     *   be referenced to both relatively to the current [ColumnsResolver] and absolutely.
     * @return A new [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing all
     *   columns after [column], excluding [column] itself.
     * @see [allBefore]
     * @see [allAfter]
     * @see [allFrom]
     * @see [allUpTo]
     ...
     * [Access APIs][org.jetbrains.kotlinx.dataframe.documentation.AccessApis].
     *
     * If [column] does not exist, the function will return an empty
     * [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet].
     *
     * &nbsp;&nbsp;&nbsp;&nbsp;
     *
     * NOTE: Using the `{}` overloads of these functions requires a
     ...
     * }.`[allAfter][org.jetbrains.kotlinx.dataframe.columns.ColumnSet.allAfter]` { myColumn
     * `[in][String.contains]` it.`[name][ColumnWithPath.name]` } }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     *
     * @param [column] The specified column after which all columns should be taken. This column can
     *   be referenced to both relatively to the current
     *   [ColumnsResolver][org.jetbrains.kotlinx.dataframe.columns.ColumnsResolver] and absolutely.
     * @return A new [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing all
     *   columns after [column], excluding [column] itself.
     * @see [allBefore]
     * @see [allAfter]
     ...
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]` { ..
     * }.`[allAfter][org.jetbrains.kotlinx.dataframe.columns.ColumnSet.allAfter]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]` { ..
     * }.`[allAfter][org.jetbrains.kotlinx.dataframe.columns.ColumnSet.allAfter]`(Type::myColumn) }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[allAfter][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.allAfter]` { myColumn }
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[allAfter][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.allAfter]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[allAfter][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.allAfter]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * someColumnGroup.`[allColsAfter][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allColsAfter]`
     * { myColumn } }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     * @see [cols]
     */
    public fun <T> SingleColumn<DataRow<T>>.allColsAfter(
        column: ColumnSelector<T, *>
    ): ColumnSet<*> {
        var resolvedCol: DataColumn<*>? = null
        return this.ensureIsColumnGroup()
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * someColumnGroup.`[allColsAfter][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allColsAfter]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * someColumnGroup.`[allColsAfter][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allColsAfter]`("myColumn")
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * someColumnGroup.`[allColsAfter][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allColsAfter]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "someColGroup".`[allColsAfter][kotlin.String.allColsAfter]` { myColumn } }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "someColGroup".`[allColsAfter][kotlin.String.allColsAfter]`("pathTo"["myColumn"]) }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "someColGroup".`[allColsAfter][kotlin.String.allColsAfter]`(Type::myColumn) }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * DataSchemaType::myColGroup.`[allColsAfter][kotlin.reflect.KProperty.allColsAfter]` { myColumn
     * } }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * DataSchemaType::myColGroup.`[allColsAfter][kotlin.reflect.KProperty.allColsAfter]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * DataSchemaType::myColGroup.`[allColsAfter][kotlin.reflect.KProperty.allColsAfter]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "pathTo"["someColGroup"].`[allColsAfter][org.jetbrains.kotlinx.dataframe.columns.ColumnPath.allColsAfter]`
     * { myColumn } }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "pathTo"["someColGroup"].`[allColsAfter][org.jetbrains.kotlinx.dataframe.columns.ColumnPath.allColsAfter]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "pathTo"["someColGroup"].`[allColsAfter][org.jetbrains.kotlinx.dataframe.columns.ColumnPath.allColsAfter]`("myColumn")
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "pathTo"["someColGroup"].`[allColsAfter][org.jetbrains.kotlinx.dataframe.columns.ColumnPath.allColsAfter]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * Creates a new [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] that contains a
     * subset of columns from [this], containing all columns from [column], including [column]
     * itself.
     *
     * [column] can be specified both relative to the current
     * [ColumnGroup][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup] or the outer scope and can
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[allFrom][ColumnsSelectionDsl.allFrom]`("someColumn") }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[colGroup][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.colGroup]`(Type::myColGroup).`[allColsFrom][SingleColumn.allColsFrom]`(someColumn)
     * }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[colsOf][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.colsOf]`<`[Int][Int]`>().`[allFrom][ColumnSet.allFrom]`(Type::someColumn)
     * }`
     *
     * #### Examples for this overload:
     *
     ...
     *   All columns up to the specified column, including that column
     *
     * @param [column] The specified column from which all columns should be taken. This column can
     *   be referenced to both relatively to the current [ColumnsResolver] and absolutely.
     * @return A new [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing all
     *   columns from [column], including [column] itself.
     * @see [allBefore]
     * @see [allAfter]
     * @see [allFrom]
     * @see [allUpTo]
     ...
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]` { ..
     * }.`[allFrom][org.jetbrains.kotlinx.dataframe.columns.ColumnSet.allFrom]` { myColumn
     * `[in][String.contains]` it.`[name][ColumnWithPath.name]` } }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]` { ..
     * }.`[allFrom][org.jetbrains.kotlinx.dataframe.columns.ColumnSet.allFrom]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]` { ..
     * }.`[allFrom][org.jetbrains.kotlinx.dataframe.columns.ColumnSet.allFrom]`(Type::myColumn) }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[allFrom][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.allFrom]` { myColumn } }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[allFrom][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.allFrom]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[allFrom][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.allFrom]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * someColumnGroup.`[allColsFrom][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allColsFrom]`
     * { myColumn } }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     * @see [cols]
     */
    public fun <T> SingleColumn<DataRow<T>>.allColsFrom(
        column: ColumnSelector<T, *>
    ): ColumnSet<*> {
        var resolvedCol: DataColumn<*>? = null
        return this.ensureIsColumnGroup()
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * someColumnGroup.`[allColsFrom][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allColsFrom]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * someColumnGroup.`[allColsFrom][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allColsFrom]`("myColumn")
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * someColumnGroup.`[allColsFrom][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allColsFrom]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "someColGroup".`[allColsFrom][kotlin.String.allColsFrom]` { myColumn } }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "someColGroup".`[allColsFrom][kotlin.String.allColsFrom]`("pathTo"["myColumn"]) }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "someColGroup".`[allColsFrom][kotlin.String.allColsFrom]`(Type::myColumn) }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * DataSchemaType::someColGroup.`[allColsFrom][kotlin.reflect.KProperty.allColsFrom]` { myColumn
     * } }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * DataSchemaType::someColGroup.`[allColsFrom][kotlin.reflect.KProperty.allColsFrom]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * DataSchemaType::someColGroup.`[allColsFrom][kotlin.reflect.KProperty.allColsFrom]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "pathTo"["someColGroup"].`[allFrom][org.jetbrains.kotlinx.dataframe.columns.ColumnPath.allColsFrom]`
     * { myColumn } }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "pathTo"["someColGroup"].`[allFrom][org.jetbrains.kotlinx.dataframe.columns.ColumnPath.allColsFrom]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "pathTo"["someColGroup"].`[allFrom][org.jetbrains.kotlinx.dataframe.columns.ColumnPath.allColsFrom]`("myColumn")
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "pathTo"["someColGroup"].`[allFrom][org.jetbrains.kotlinx.dataframe.columns.ColumnPath.allColsFrom]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * Creates a new [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] that contains a
     * subset of columns from [this], containing all columns before [column], excluding [column]
     * itself.
     *
     * [column] can be specified both relative to the current
     * [ColumnGroup][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup] or the outer scope and can
     ...
     * [Access APIs][org.jetbrains.kotlinx.dataframe.documentation.AccessApis].
     *
     * If [column] does not exist, the function will return a [ColumnSet][ColumnSet] containing all
     * columns.
     *
     * &nbsp;&nbsp;&nbsp;&nbsp;
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[allBefore][ColumnsSelectionDsl.allBefore]`("someColumn") }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[colGroup][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.colGroup]`(Type::myColGroup).`[allColsBefore][SingleColumn.allColsBefore]`(someColumn)
     * }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[colsOf][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.colsOf]`<`[Int][Int]`>().`[allBefore][ColumnSet.allBefore]`(Type::someColumn)
     * }`
     *
     * #### Examples for this overload:
     *
     ...
     *   can be referenced to both relatively to the current [ColumnsResolver] and absolutely.
     * @return A new [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing all
     *   columns before [column], excluding [column] itself.
     * @see [allBefore]
     * @see [allAfter]
     * @see [allFrom]
     * @see [allUpTo]
     ...
     * [Access APIs][org.jetbrains.kotlinx.dataframe.documentation.AccessApis].
     *
     * If [column] does not exist, the function will return a
     * [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing all columns.
     *
     * &nbsp;&nbsp;&nbsp;&nbsp;
     *
     * NOTE: Using the `{}` overloads of these functions requires a
     ...
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]` { ..
     * }.`[allBefore][org.jetbrains.kotlinx.dataframe.columns.ColumnSet.allBefore]` { myColumn
     * `[in][String.contains]` it.`[name][ColumnWithPath.name]` } }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * @param [column] The specified column before which all columns should be taken. This column
     *   can be referenced to both relatively to the current
     *   [ColumnsResolver][org.jetbrains.kotlinx.dataframe.columns.ColumnsResolver] and absolutely.
     * @return A new [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing all
     *   columns before [column], excluding [column] itself.
     * @see [allBefore]
     ...
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]` { ..
     * }.`[allBefore][org.jetbrains.kotlinx.dataframe.columns.ColumnSet.allBefore]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]` { ..
     * }.`[allBefore][org.jetbrains.kotlinx.dataframe.columns.ColumnSet.allBefore]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[allBefore][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.allBefore]` { myColumn }
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[allBefore][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.allBefore]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[allBefore][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.allBefore]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * someColumnGroup.`[allColsBefore][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allColsBefore]`
     * { myColumn } }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     * @see [cols]
     */
    public fun <T> SingleColumn<DataRow<T>>.allColsBefore(
        column: ColumnSelector<T, *>
    ): ColumnSet<*> {
        var resolvedCol: DataColumn<*>? = null
        return this.ensureIsColumnGroup()
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * someColumnGroup.`[allColsBefore][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allColsBefore]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * someColumnGroup.`[allColsBefore][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allColsBefore]`("myColumn")
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * someColumnGroup.`[allColsBefore][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allColsBefore]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "someColGroup".`[allColsBefore][kotlin.String.allColsBefore]`("pathTo"["myColumn"]) }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "someColGroup".`[allColsBefore][kotlin.String.allColsBefore]`(Type::myColumn) }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * DataSchemaType::someColGroup.`[allColsBefore][kotlin.reflect.KProperty.allColsBefore]` {
     * myColumn } }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * DataSchemaType::someColGroup.`[allColsBefore][kotlin.reflect.KProperty.allColsBefore]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * DataSchemaType::someColGroup.`[allColsBefore][kotlin.reflect.KProperty.allColsBefore]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "pathTo"["someColGroup"].`[allColsBefore][org.jetbrains.kotlinx.dataframe.columns.ColumnPath.allColsBefore]`
     * { myColumn } }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "pathTo"["someColGroup"].`[allColsBefore][org.jetbrains.kotlinx.dataframe.columns.ColumnPath.allColsBefore]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "pathTo"["someColGroup"].`[allColsBefore][org.jetbrains.kotlinx.dataframe.columns.ColumnPath.allColsBefore]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * Creates a new [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] that contains a
     * subset of columns from [this], containing all columns up to [column], including [column]
     * itself.
     *
     * [column] can be specified both relative to the current
     * [ColumnGroup][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup] or the outer scope and can
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[allUpTo][ColumnsSelectionDsl.allUpTo]`("someColumn") }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[colGroup][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.colGroup]`(Type::myColGroup).`[allColsUpTo][SingleColumn.allColsUpTo]`(someColumn)
     * }`
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[colsOf][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.colsOf]`<`[Int][Int]`>().`[allUpTo][ColumnSet.allUpTo]`(Type::someColumn)
     * }`
     *
     * #### Examples for this overload:
     *
     ...
     *   All columns up to the specified column, including that column
     *
     * @param [column] The specified column up to which all columns should be taken. This column can
     *   be referenced to both relatively to the current [ColumnsResolver] and absolutely.
     * @return A new [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing all
     *   columns up to [column], including [column] itself.
     * @see [allBefore]
     * @see [allAfter]
     * @see [allFrom]
     * @see [allUpTo]
     ...
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]` { ..
     * }.`[allUpTo][org.jetbrains.kotlinx.dataframe.columns.ColumnSet.allUpTo]` { myColumn
     * `[in][String.contains]` it.`[name][ColumnWithPath.name]` } }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]` { ..
     * }.`[allUpTo][org.jetbrains.kotlinx.dataframe.columns.ColumnSet.allUpTo]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]` { ..
     * }.`[allUpTo][org.jetbrains.kotlinx.dataframe.columns.ColumnSet.allUpTo]`(Type::myColumn) }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[allUpTo][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allColsUpTo]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[allUpTo][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allColsUpTo]`("myColumn")
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * `[allUpTo][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allColsUpTo]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * someColumnGroup.`[allColsUpTo][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allColsUpTo]`
     * { myColumn } }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     * @see [cols]
     */
    public fun <T> SingleColumn<DataRow<T>>.allColsUpTo(
        column: ColumnSelector<T, *>
    ): ColumnSet<*> {
        var resolvedCol: DataColumn<*>? = null
        return this.ensureIsColumnGroup()
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * someColumnGroup.`[allColsUpTo][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allColsUpTo]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * someColumnGroup.`[allColsUpTo][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allColsUpTo]`("myColumn")
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * someColumnGroup.`[allColsUpTo][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.allColsUpTo]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "someColGroup".`[allColsUpTo][kotlin.String.allColsUpTo]` { myColumn } }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "someColGroup".`[allColsUpTo][kotlin.String.allColsUpTo]`("pathTo"["myColumn"]) }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "someColGroup".`[allColsUpTo][kotlin.String.allColsUpTo]`(Type::myColumn) }`
     *
     * #### Flavors of All (Cols):
     *
     * - [`all(Cols)`][org.jetbrains.kotlinx.dataframe.api.AllColumnsSelectionDsl.allCols]`()`: All
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * DataSchemaType::someColGroup.`[allColsUpTo][kotlin.reflect.KProperty.allColsUpTo]` { myColumn
     * } }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * DataSchemaType::someColGroup.`[allColsUpTo][kotlin.reflect.KProperty.allColsUpTo]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * DataSchemaType::someColGroup.`[allColsUpTo][kotlin.reflect.KProperty.allColsUpTo]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "pathTo"["someColGroup"].`[allColsUpTo][org.jetbrains.kotlinx.dataframe.columns.ColumnPath.allColsUpTo]`
     * { myColumn } }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "pathTo"["someColGroup"].`[allColsUpTo][org.jetbrains.kotlinx.dataframe.columns.ColumnPath.allColsUpTo]`("pathTo"["myColumn"])
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "pathTo"["someColGroup"].`[allColsUpTo][org.jetbrains.kotlinx.dataframe.columns.ColumnPath.allColsUpTo]`("myColumn")
     * }`
     *
     * #### Flavors of All (Cols):
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * "pathTo"["someColGroup"].`[allColsUpTo][org.jetbrains.kotlinx.dataframe.columns.ColumnPath.allColsUpTo]`(Type::myColumn)
     * }`
     *
     * #### Flavors of All (Cols):
     *
...
/**
 * If [this] is a [SingleColumn] containing a single [ColumnGroup] (like
 * [SingleColumn][SingleColumn]`<`[AnyRow][AnyRow]`>` or
 * [ColumnsSelectionDsl][ColumnsSelectionDsl]), it returns a
 * [(transformable) ColumnSet][TransformableColumnSet] containing the children of this
 * [ColumnGroup], else it simply returns a [(transformable) ColumnSet][TransformableColumnSet] from
 * [this] (like when [this] is a [ColumnSet]).
 */
@PublishedApi
internal fun ColumnsResolver<*>.allColumnsInternal(
    removePaths: Boolean = false
): TransformableColumnSet<*> = transform { cols ->
...
/**
 * Returns a new ColumnSet containing all columns after the first column that matches the given
 * predicate.
 *
 * @param colByPredicate a function that takes a ColumnWithPath and returns true if the column
 *   matches the predicate, false otherwise
 * @return a new ColumnSet containing all columns after the first column that matches the given
 *   predicate
 */
@PublishedApi
internal inline fun ColumnsResolver<*>.allAfterInternal(
    crossinline colByPredicate: ColumnFilter<*>
): ColumnSet<*> {
    var take = false
    return colsInternal {
        if (take) {
...
/**
 * Returns a column set containing all columns from the internal column set that satisfy the given
 * predicate.
 *
 * @param colByPredicate the predicate used to determine if a column should be included in the
 *   resulting set
 * @return a column set containing all columns that satisfy the predicate
 */
@PublishedApi
internal inline fun ColumnsResolver<*>.allFromInternal(
    crossinline colByPredicate: ColumnFilter<*>
): ColumnSet<*> {
    var take = false
    return colsInternal {
...
/**
 * Returns a new ColumnSet containing all columns before the first column that satisfies the given
 * predicate.
 *
 * @param colByPredicate the predicate function used to determine if a column should be included in
 *   the returned ColumnSet
 * @return a new ColumnSet containing all columns that come before the first column that satisfies
 *   the given predicate
 */
@PublishedApi
internal inline fun ColumnsResolver<*>.allBeforeInternal(
    crossinline colByPredicate: ColumnFilter<*>
): ColumnSet<*> {
    var take = true
    return colsInternal {
...
/**
 * Returns a ColumnSet containing all columns up to (and including) the first column that satisfies
 * the given predicate.
 *
 * @param colByPredicate a predicate function that takes a ColumnWithPath and returns true if the
 *   column satisfies the desired condition.
 * @return a ColumnSet containing all columns up to the first column that satisfies the given
 *   predicate.
 */
@PublishedApi
internal inline fun ColumnsResolver<*>.allUpToInternal(
    crossinline colByPredicate: ColumnFilter<*>
): ColumnSet<*> {
    var take = true
    return colsInternal {
