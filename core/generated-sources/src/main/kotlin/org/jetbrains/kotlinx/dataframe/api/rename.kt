...
import org.jetbrains.kotlinx.dataframe.impl.columns.RenamedSingleColumn
...
internal interface RenameDocs {
     ...
     * #### For example:
     *
     * <code>`df`</code>`.`[rename][org.jetbrains.kotlinx.dataframe.api.rename]` { length `[and][org.jetbrains.kotlinx.dataframe.api.AndColumnsSelectionDsl.and]` age }`
     *
...
public interface RenameColumnsSelectionDsl {
    ...
    public infix fun <C> SingleColumn<C>.named(newName: String): SingleColumn<C> = RenamedSingleColumn(this, newName)
