...
public interface WithoutNullsColumnsSelectionDsl {
    ...
    /**
     * ## (Cols) Without Nulls
     * Returns a new [ColumnSet] that contains only columns in [this] that do not have `null`
     * values.
     *
     * This function operates solely on columns at the top-level.
     *
     * NOTE: For [column groups][ColumnGroup], `withoutNulls` is named `colsWithoutNulls` to avoid
     * confusion.
     *
     * ### Check out: [Grammar]
     *
     ...
     * `[all][ColumnsSelectionDsl.all]`().`[nameContains][ColumnsSelectionDsl.colsNameContains]`("middleName").`[withoutNulls][ColumnSet.withoutNulls]`()
     * }`
     *
     * `df.`[select][DataFrame.select]` { `[withoutNulls][ColumnsSelectionDsl.withoutNulls]`() }`
     *
     * `df.`[select][DataFrame.select]` {
     * Type::userData.`[colsWithoutNulls][SingleColumn.colsWithoutNulls]`() }`
     *
     * #### Examples for this overload:
     *
     * @return A [ColumnSet] containing only columns that do not contain `null`s and are thus
     *   non-nullable.
     */
    ...
    /**
     * ## (Cols) Without Nulls
     * Returns a new [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] that contains
     * only columns in [this] that do not have `null` values.
     *
     * This function operates solely on columns at the top-level.
     *
     ...
     *
     * ### Check out:
     * [Grammar][org.jetbrains.kotlinx.dataframe.api.WithoutNullsColumnsSelectionDsl.Grammar]
     *
     * #### For Example:
     *
     ...
     *
     * `df.`[select][org.jetbrains.kotlinx.dataframe.DataFrame.select]` {
     * Type::userData.`[colsWithoutNulls][org.jetbrains.kotlinx.dataframe.columns.SingleColumn.colsWithoutNulls]`()
     * }`
     *
     * #### Examples for this overload:
     *
     * @return A [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] containing only
     *   columns that do not contain `null`s and are thus non-nullable.
     */
