...
public interface ColumnSelectionDsl<out T> : ColumnsContainer<T> {
     ...
     * [ColumnReference][org.jetbrains.kotlinx.dataframe.columns.ColumnReference] or
     * [-Accessor][org.jetbrains.kotlinx.dataframe.columns.ColumnAccessor] from the
     * [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame].
     *
     * This is a shorthand for
     * [get][org.jetbrains.kotlinx.dataframe.ColumnsContainer.get]`(myColumn)`.
     *
     ...
     * with `operator fun String.get(column: String)`, for instance:
     * ```kotlin
    ...
    /**
     * Retrieves the value of this [KProperty Accessor][KProperty] from the
     * [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame].
     *
     * This is a shorthand for
     * [get][org.jetbrains.kotlinx.dataframe.ColumnsContainer.get]`(MyType::myColumn)`.
     *
