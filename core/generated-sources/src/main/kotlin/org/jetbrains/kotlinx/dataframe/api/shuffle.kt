...
/**
 * Returns a new [DataColumn] with the same values in random order using the provided [random]
 * source.
 *
 ...
 */
public fun <T> DataFrame<T>.shuffle(random: Random): DataFrame<T> =
    getRows(indices.shuffled(random))
