 ...
 * To include those in the mean, [<code>flatten</code>][DataFrame.flatten] the DataFrame first.
 *
 ...
 *
 * See also:
 * - [<code>`meanFor`</code>][DataFrame.meanFor] — the same, but for an explicit selection of columns.
 ...
 *   If `false` (the default), a [<code>`NaN`</code>][org.jetbrains.kotlinx.dataframe.documentation.NaN] in the input is propagated to the result.
 *   This only has an effect on [<code>Double</code>][Double] and [<code>Float</code>][Float] values.
 * @param [columns] The [<code>ColumnsSelector</code>][org.jetbrains.kotlinx.dataframe.ColumnsSelector] used to select the columns to compute the mean of.
 ...
 *   If `false` (the default), a [<code>`NaN`</code>][org.jetbrains.kotlinx.dataframe.documentation.NaN] in the input is propagated to the result.
 *   This only has an effect on [<code>Double</code>][Double] and [<code>Float</code>][Float] values.
 * @param [expression] The [<code>RowExpression</code>][org.jetbrains.kotlinx.dataframe.RowExpression] to compute the value to average for each row.
 * @return The mean of the values [<code>expression</code>][expression] returns, as a [<code>Double</code>][Double].
 */
