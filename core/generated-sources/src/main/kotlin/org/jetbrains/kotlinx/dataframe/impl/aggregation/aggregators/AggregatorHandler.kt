...
/**
 * Common interface for [Aggregator] handlers or "injector" objects that can build up an
 * [Aggregator] instance.
 *
 * When an [Aggregator] is instantiated, the [init] function of each
 * [AggregatorAggregationHandlers][AggregatorAggregationHandler] is called, which allows the handler
 * to refer to [Aggregator] instance via [aggregator].
 */
