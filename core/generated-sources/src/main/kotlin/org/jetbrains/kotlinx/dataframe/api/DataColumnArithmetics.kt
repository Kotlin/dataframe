...
/**
 * Returns a [DataColumn] containing the inverse [Boolean] values
 * of this [DataColumn].
 *
 *
 *
 ...
 * ```
 *
 * @return A [ColumnReference] containing the negated [Boolean] values of the original [reference][ColumnReference],
 * while preserving `null` values.
 */
@JvmName("notBooleanNullable")
...
/**
 * Returns a [DataColumn] where each element is the result of adding [value]
 * to the corresponding element of this [DataColumn].
 *
 * That is, [value] is added to each element of this [DataColumn].
 *
 *
 *
 * ### Example
 ...
 * See also .
 *
 * @param [value] The value to add to each element of this [DataColumn].
 *
 * @return A [DataColumn] containing the results of adding [value]
 * to each element of this [DataColumn].
 */
 ...
 * ```
 *
 * See also [minus][ColumnReference.minus], [times][ColumnReference.times], [div][ColumnReference.div].
 *
...
/**
 * Returns a [DataColumn] where each element is the result of adding
 ...
 * See also .
 *
 * @param [column] A [DataColumn] containing the elements to add
 * to this [Int].
 *
 * @return A [DataColumn] containing the results of adding
 * the corresponding element of [column] to this [Int].
 */
...
/**
 * Returns a [DataColumn] of [String] values
 * obtained by converting each element of this [AnyCol]
 ...
 * ```
 *
 * See also [plus][DataColumn.plus].
 *
 * @param [str] The [String] to append to each element of this [AnyCol].
 *
 * @return A [DataColumn] of [String] values where each element is the result
 * of concatenating the corresponding element of this [AnyCol] with [str].
 */
...
/**
 * Returns a [DataColumn] containing negatives
 * of the corresponding elements of this [DataColumn].
 *
 * The sign of each element in this [DataColumn] is flipped:
 ...
 * ```
 *
 * @return A [DataColumn] containing negatives
 * of the corresponding elements of this [DataColumn].
 */
...
/**
 * Returns a [DataColumn] containing the results
 * of multiplying each element of this [DataColumn] by [value].
 *
 *
 *
 * ### Example
 ...
 * See also .
 *
 * @param [value] The value to multiply each element of this [DataColumn] by.
 *
 * @return A [DataColumn] containing the results
 * of multiplying each element of this [DataColumn] by [value].
 */
...
/**
 * Returns a [DataColumn] containing the results of dividing
 * each element of this [DataColumn] by [value].
 *
 ...
 * See also .
 *
 * @param [value] The value to divide each element of this [DataColumn] by.
 *
 * @throws [ArithmeticException] if [value] is equal to zero.
 *
 * @return A [DataColumn] containing the results of dividing
 * each element of this [DataColumn] by [value].
 */
...
/**
 * Returns a [ColumnReference]
 *  containing the results of dividing
 * each element of this [ColumnReference]
 *  by [value].
 *
 * The result of each division is truncated to an integer that is closer to zero.
 *
 ...
 *
 * @param [value] The value to divide each element of this [ColumnReference]
 *  by.
 *
 * @throws [ArithmeticException] if [value] is equal to zero.
 *
 * @return A [ColumnReference]
 *  containing the results of dividing
 * each element of this [ColumnReference]
 *  by [value].
 */
 ...
 * See also .
 *
 * @param [column] A [DataColumn] containing the elements
 ...
 * [plus][ColumnReference.plus], [minus][ColumnReference.minus].
 *
 * @param [column] A [ColumnReference]
 ...
 *
 * @return A [DataColumn] containing `true` for elements  [value], and `false` otherwise.
 */
