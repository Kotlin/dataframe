...
public fun <T : Number> DataColumn<T?>.std(skipNA: Boolean = skipNaN_default, ddof: Int = ddof_default): Double =
...
public fun AnyRow.rowStd(skipNA: Boolean = skipNaN_default, ddof: Int = ddof_default): Double =
...
public fun <T> DataFrame<T>.std(skipNA: Boolean = skipNaN_default, ddof: Int = ddof_default): DataRow<T> =
...
public fun <T> DataFrame<T>.stdFor(
    ...
    skipNA: Boolean = skipNaN_default,
    ddof: Int = ddof_default,
): DataRow<T> = stdFor(skipNA, ddof) { columns.toColumnsSetOf() }
...
public fun <T> Grouped<T>.std(skipNA: Boolean = skipNaN_default, ddof: Int = ddof_default): DataFrame<T> =
    stdFor(skipNA, ddof, numberColumns())
...
public fun <T> Pivot<T>.std(
    ...
    skipNA: Boolean = skipNaN_default,
    ddof: Int = ddof_default,
): DataRow<T> = std(skipNA, ddof) { columns.toColumnsSetOf() }
...
public fun <T> PivotGroupBy<T>.std(
    ...
    skipNA: Boolean = skipNaN_default,
    ddof: Int = ddof_default,
): DataFrame<T> = std(skipNA, ddof) { columns.toColumnsSetOf() }
