 ...
 * To include those in the standard deviation, [<code>flatten</code>][DataFrame.flatten] the DataFrame first.
 *
 ...
 *   unbiased sample standard deviation (as in R). Use `0` for the population standard deviation
 *   (as in Numpy).
 * @param [columns] The [<code>ColumnsSelector</code>][org.jetbrains.kotlinx.dataframe.ColumnsSelector] used to select the columns to compute the standard deviation of.
 ...
 *   unbiased sample standard deviation (as in R). Use `0` for the population standard deviation
 *   (as in Numpy).
 * @param [expression] The [<code>RowExpression</code>][org.jetbrains.kotlinx.dataframe.RowExpression] to compute the value to include for each row.
 * @return The standard deviation of the values [<code>expression</code>][expression] returns, as a [<code>Double</code>][Double].
 */
