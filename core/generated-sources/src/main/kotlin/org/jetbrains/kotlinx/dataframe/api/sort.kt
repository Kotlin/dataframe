 ...
 *
 * &nbsp;&nbsp;&nbsp;&nbsp;`name.`[sortWith][sortWith]`(myComparator)
 * `[and][ColumnsSelectionDsl.and]` `[allAfter][ColumnsSelectionDsl.allAfter]`(name)`
 *
 * `}`
 *
 ...
 *
 * This function returns the sorted version of the current
 * [ValueColumn][org.jetbrains.kotlinx.dataframe.columns.ValueColumn],
 * [FrameColumn][org.jetbrains.kotlinx.dataframe.columns.FrameColumn], or
 * [ColumnGroup][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup] based on the given
 * [Comparator]. The [comparator] can either be given as an instance of [Comparator], or directly as
 * a lambda.
 *
 * #### For example
 *
 * `df`[`[`][org.jetbrains.kotlinx.dataframe.DataFrame.get]`"price"`[`]`][org.jetbrains.kotlinx.dataframe.DataFrame.get]`.`[sortWith][org.jetbrains.kotlinx.dataframe.api.sortWith]`
 * { a, b -> a - b }`
 *
 * &nbsp;&nbsp;&nbsp;&nbsp;
 *
 ...
 *
 * &nbsp;&nbsp;&nbsp;&nbsp;`name.`[sortWith][org.jetbrains.kotlinx.dataframe.api.sortWith]`(myComparator)
 * `[and][org.jetbrains.kotlinx.dataframe.api.AndColumnsSelectionDsl.and]`
 * `[allAfter][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.allAfter]`(name)`
 *
 * `}`
 *
 * @param [comparator] The [Comparator] to use for sorting the
 *   [DataColumn][org.jetbrains.kotlinx.dataframe.DataColumn]. This can either be a
 *   [Comparator]<[T]> or a lambda of type `(`[T][T]`, `[T][T]`) -> `[Int][Int].
 * @return The sorted [DataColumn][org.jetbrains.kotlinx.dataframe.DataColumn] [this] of the same
 *   type as the receiver.
 * @receiver The [DataColumn][org.jetbrains.kotlinx.dataframe.DataColumn] to sort. This can be
 *   either a [ValueColumn][org.jetbrains.kotlinx.dataframe.columns.ValueColumn],
 *   [FrameColumn][org.jetbrains.kotlinx.dataframe.columns.FrameColumn], or
 *   [ColumnGroup][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup] and will dictate the return
