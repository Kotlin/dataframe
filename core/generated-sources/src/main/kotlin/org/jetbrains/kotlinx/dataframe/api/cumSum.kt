 ...
 *
 * Computes the cumulative sum of the values in the [DataColumn].
 *
 ...
 *
 * @return A new [DataColumn] of the same type with the cumulative sum of the values.
 *
 *
 ...
 * ## The CumSum Operation
 *
 * Computes the cumulative sum of the values in the [DataFrame].
 *
 * __NOTE:__ If the column contains nullable values and `skipNA` is set to `true`,
 * skips null values when computing the cumulative sum.
 * Otherwise, any null value encountered will propagate null values in the output from that point onward.
 ...
 * @param [skipNA] Whether to skip null values (default: `true`).
 *
 * @return A new [DataFrame] of the same type with the cumulative sum of the values.
 *
 ...
 * ## The CumSum Operation
 *
 * Computes the cumulative sum of the values in the [GroupBy].
 *
 * __NOTE:__ If the column contains nullable values and `skipNA` is set to `true`,
 * skips null values when computing the cumulative sum.
 * Otherwise, any null value encountered will propagate null values in the output from that point onward.
 ...
 * @param [skipNA] Whether to skip null values (default: `true`).
 *
 * @return A new [GroupBy] of the same type with the cumulative sum of the values.
 *
 * @see [Selecting Columns][org.jetbrains.kotlinx.dataframe.api.Select.SelectSelectingOptions].
 * @see <a href="https://kotlin.github.io/dataframe/cumsum.html">See `cumSum` on the documentation website.</a>
 * .
