 ...
 * its declared type. A [<code>ColumnGroup</code>][ColumnGroup] accepts `null`, a [<code>DataRow</code>][DataRow], or a [<code>List</code>][List]
 * whose values follow the group's column order. A [<code>FrameColumn</code>][FrameColumn] accepts `null` or a [<code>DataFrame</code>][DataFrame].
 *
