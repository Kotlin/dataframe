 ...
 *
 * <code>`df`</code>`.`<code>`operation`</code>` {
...
internal interface SelectingColumns {
     ...
     * you to return a [SingleColumn] or [ColumnSet] (so, a [ColumnsResolver]). This is an entity
     * formed by calling any (combination) of the functions in the DSL that is or can be resolved
    ...
    interface ColumnsSelectionDsl {
         ...
         * [Columns Selector][org.jetbrains.kotlinx.dataframe.ColumnsSelector] lambda, which
         * operates in the context of the
         * [Columns Selection DSL][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl] and
         * expects you to return a
         * [SingleColumn][org.jetbrains.kotlinx.dataframe.columns.SingleColumn] or
         * [ColumnSet][org.jetbrains.kotlinx.dataframe.columns.ColumnSet] (so, a
         ...
         * #### For example:
         *
         * <code>`df`</code>`.`<code>`operation`</code>` { length `[and][ColumnsSelectionDsl.and]`
         * age }`
         *
    ...
    /**
     * Select or express a single column using the Column Selection DSL. (Any
     ...
     * context of the [Column Selection DSL][org.jetbrains.kotlinx.dataframe.api.ColumnSelectionDsl]
     * and expects you to return a [SingleColumn]. This is an entity formed by calling any
     * (combination) of the functions in the DSL that is or can be resolved into a single column.
     *
     * &nbsp;&nbsp;&nbsp;&nbsp;
     *
     * [See Column Selectors on the documentation
    ...
    interface ColumnSelectionDsl {
         ...
         *
         * This DSL is initiated by a
         * [Column Selector][org.jetbrains.kotlinx.dataframe.ColumnSelector] lambda, which operates
         * in context of the
         * [Column Selection DSL][org.jetbrains.kotlinx.dataframe.api.ColumnSelectionDsl] and
         * expects you to return a
         * [SingleColumn][org.jetbrains.kotlinx.dataframe.columns.SingleColumn]. This is an entity
         * formed by calling any (combination) of the functions in the DSL that is or can be
         * resolved into a single column.
         *
         * &nbsp;&nbsp;&nbsp;&nbsp;
         *
         * [See Column Selectors on the documentation
