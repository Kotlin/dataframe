 ...
 *
 * Replaces `null` values with given value or expression. Specific case of [update].
 *
...
internal interface FillNulls {
     ...
     *
     * [**fillNulls**][fillNulls]**` {
     * `**[`columns`][org.jetbrains.kotlinx.dataframe.documentation.SelectingColumns]**` }`**
     *
     * &nbsp;&nbsp;&nbsp;&nbsp; `[
     * `__`.`__[**`where`**][org.jetbrains.kotlinx.dataframe.api.Update.where]**` {
     * `**[`rowValueCondition`][org.jetbrains.kotlinx.dataframe.documentation.SelectingRows.RowValueCondition.WithExample]**`
     * } `**`]`
     *
     * &nbsp;&nbsp;&nbsp;&nbsp; `[
     ...
     *
     * &nbsp;&nbsp;&nbsp;&nbsp;
     * __`.`__[**`with`**][org.jetbrains.kotlinx.dataframe.api.Update.with]**` {
     * `**[`rowExpression`][org.jetbrains.kotlinx.dataframe.documentation.ExpressionsGivenRow.RowValueExpression.WithExample]**`
     * }`**
     *
     * &nbsp;&nbsp;&nbsp;&nbsp; `|
     * `__`.`__[**`notNull`**][org.jetbrains.kotlinx.dataframe.api.Update.notNull]**` {
     ...
     *
     * &nbsp;&nbsp;&nbsp;&nbsp; `|
     * `__`.`__[**`perCol`**][org.jetbrains.kotlinx.dataframe.api.Update.perCol]**` {
     * `**[`colExpression`][org.jetbrains.kotlinx.dataframe.documentation.ExpressionsGivenColumn.ColumnExpression.WithExample]**`
     * }`**
     *
     * &nbsp;&nbsp;&nbsp;&nbsp; `|
     * `__`.`__[**`perRowCol`**][org.jetbrains.kotlinx.dataframe.api.Update.perRowCol]**` {
     * `**[`rowColExpression`][org.jetbrains.kotlinx.dataframe.documentation.ExpressionsGivenRowAndColumn.RowColumnExpression.WithExample]**`
     * }`**
     *
     * &nbsp;&nbsp;&nbsp;&nbsp; `|
     ...
     *
     * &nbsp;&nbsp;&nbsp;&nbsp; `|
     * `__`.`__[**`asFrame`**][org.jetbrains.kotlinx.dataframe.api.Update.asFrame]**` {
     * `**[`dataFrameExpression`][org.jetbrains.kotlinx.dataframe.documentation.ExpressionsGivenDataFrame.DataFrameExpression.WithExample]**`
     * }`**
     */
     ...
     * #### For example:
     *
     * <code>`df`</code>`.`[fillNulls][org.jetbrains.kotlinx.dataframe.api.fillNulls]` { length
     * `[and][ColumnsSelectionDsl.and]` age }`
     *
     * <code>`df`</code>`.`[fillNulls][org.jetbrains.kotlinx.dataframe.api.fillNulls]` {
 ...
 * ## The Fill Nulls Operation
 *
 * Replaces `null` values with given value or expression. Specific case of
 * [update][org.jetbrains.kotlinx.dataframe.api.update].
 *
 ...
 * &nbsp;&nbsp;&nbsp;&nbsp;
 *
 * The columns to update need to be selected. See
 * [Selecting Columns][org.jetbrains.kotlinx.dataframe.api.FillNulls.FillNullsSelectingOptions] for
 * all the selecting options.
 *
 ...
 * }`
 *
 * @param [columns] The [Columns Selector][org.jetbrains.kotlinx.dataframe.ColumnsSelector] used to
 *   select the columns of this [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame] to update.
 */
 ...
 * #### For example:
 *
 * <code>`df`</code>`.`[fillNulls][org.jetbrains.kotlinx.dataframe.api.fillNulls]`("length", "age")`
 *
 * @param [columns] The [Strings][String] corresponding to the names of columns belonging to this
 *   [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame] to update.
 */
public fun <T> DataFrame<T>.fillNulls(vararg columns: String): Update<T, Any?> = fillNulls {
    columns.toColumnSet()
}
 ...
 * ### This Fill Nulls Overload
 *
 * @param [columns] The [KProperties][KProperty] corresponding to columns of this
 *   [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame] to update.
 */
@Deprecated(DEPRECATED_ACCESS_API)
@AccessApiOverload
public fun <T, C> DataFrame<T>.fillNulls(vararg columns: KProperty<C>): Update<T, C?> = fillNulls {
    columns.toColumnSet()
}
 ...
 * ### This Fill Nulls Overload
 *
 * @param [columns] The [Column References][org.jetbrains.kotlinx.dataframe.columns.ColumnReference]
 *   of this [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame] to update.
 */
@Deprecated(DEPRECATED_ACCESS_API)
@AccessApiOverload
...
internal inline val Any?.isNaN: Boolean
    get() = (this is Double && isNaN()) || (this is Float && isNaN())

/**
 * Returns `true` if [this] is considered NA. "NA", in DataFrame, roughly means `null` or `NaN`.
 *
...
/**
 * Is `true` if [this] is considered NA. "NA", in DataFrame, roughly means `null` or `NaN`.
 *
 * @see NA
 */
...
internal inline val AnyCol.canHaveNaN: Boolean
    get() = typeClass.let { it == Double::class || it == Float::class }
 ...
 * @see NA
 */
internal inline val AnyCol.canHaveNA: Boolean
    get() = hasNulls() || canHaveNaN || kind() != ColumnKind.Value
 ...
 * @see NA
 */
internal inline val Double?.isNA: Boolean
    get() = this == null || this.isNaN()
 ...
 * @see NA
 */
internal inline val Float?.isNA: Boolean
    get() = this == null || this.isNaN()
 ...
 *
 * Replaces [`NaN`][NaN] values with given value or expression. Specific case of [update].
 *
...
internal interface FillNaNs {
     ...
     * #### For example:
     *
     * <code>`df`</code>`.`[fillNaNs][org.jetbrains.kotlinx.dataframe.api.fillNaNs]` { length
     * `[and][ColumnsSelectionDsl.and]` age }`
     *
     * <code>`df`</code>`.`[fillNaNs][org.jetbrains.kotlinx.dataframe.api.fillNaNs]` {
     * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]`(1..5) }`
     *
     * <code>`df`</code>`.`[fillNaNs][org.jetbrains.kotlinx.dataframe.api.fillNaNs]` {
     * `[colsOf][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.colsOf]`<`[Double][Double]`>()
 ...
 * ## The Fill NaNs Operation
 *
 * Replaces [`NaN`][org.jetbrains.kotlinx.dataframe.documentation.NaN] values with given value or
 * expression. Specific case of [update][org.jetbrains.kotlinx.dataframe.api.update].
 *
 ...
 *
 * The columns to update need to be selected. See
 * [Selecting Columns][org.jetbrains.kotlinx.dataframe.api.FillNaNs.FillNaNsSelectingOptions] for
 * all the selecting options.
 *
 ...
 * #### For example:
 *
 * <code>`df`</code>`.`[fillNaNs][org.jetbrains.kotlinx.dataframe.api.fillNaNs]`("length", "age")`
 *
 * @param [columns] The [Strings][String] corresponding to the names of columns belonging to this
 *   [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame] to update.
 */
public fun <T> DataFrame<T>.fillNaNs(vararg columns: String): Update<T, Any?> = fillNaNs {
    columns.toColumnSet()
}
...
@Deprecated(DEPRECATED_ACCESS_API)
@AccessApiOverload
public fun <T, C> DataFrame<T>.fillNaNs(vararg columns: KProperty<C>): Update<T, C> = fillNaNs {
    columns.toColumnSet()
}
 ...
 *
 * Replaces [`NA`][NA] values with given value or expression. Specific case of [update].
 *
...
internal interface FillNA {
     ...
     * #### For example:
     *
     * <code>`df`</code>`.`[fillNA][org.jetbrains.kotlinx.dataframe.api.fillNA]` { length
     * `[and][ColumnsSelectionDsl.and]` age }`
     *
     * <code>`df`</code>`.`[fillNA][org.jetbrains.kotlinx.dataframe.api.fillNA]` {
     * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]`(1..5) }`
     *
     * <code>`df`</code>`.`[fillNA][org.jetbrains.kotlinx.dataframe.api.fillNA]` {
     * `[colsOf][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.colsOf]`<`[Double][Double]`>()
     ...
     * #### For example:
     *
     * <code>`df`</code>`.`[fillNA][org.jetbrains.kotlinx.dataframe.api.fillNA]`("length", "age")`
     */
 ...
 * ## The Fill NA Operation
 *
 * Replaces [`NA`][org.jetbrains.kotlinx.dataframe.documentation.NA] values with given value or
 * expression. Specific case of [update][org.jetbrains.kotlinx.dataframe.api.update].
 *
 ...
 *
 * The columns to update need to be selected. See
 * [Selecting Columns][org.jetbrains.kotlinx.dataframe.api.FillNA.FillNASelectingOptions] for all
 * the selecting options.
 *
 ...
 *   [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame] to update.
 */
public fun <T> DataFrame<T>.fillNA(vararg columns: String): Update<T, Any?> = fillNA {
    columns.toColumnSet()
}
...
@Deprecated(DEPRECATED_ACCESS_API)
@AccessApiOverload
public fun <T, C> DataFrame<T>.fillNA(vararg columns: KProperty<C>): Update<T, C?> = fillNA {
    columns.toColumnSet()
}
...
@Deprecated(DEPRECATED_ACCESS_API)
@AccessApiOverload
public fun <T, C> DataFrame<T>.fillNA(vararg columns: ColumnReference<C>): Update<T, C?> = fillNA {
    columns.toColumnSet()
}
 ...
 *
 * Removes rows with `null` values. Specific case of
 * [drop][org.jetbrains.kotlinx.dataframe.DataFrame.drop].
 *
 * Optionally, you can select which columns to operate on (see
 * [Selecting Columns][org.jetbrains.kotlinx.dataframe.api.DropNulls.DropNullsSelectingOptions]).
 *
 * Also, you can supply `whereAllNull = true` to only drop rows where all selected cells are `null`.
 * By default, rows are dropped if any of the selected cells are `null`.
 *
 * For more information:
 ...
 * #### For example:
 *
 * <code>`df`</code>`.`[dropNulls][org.jetbrains.kotlinx.dataframe.api.dropNulls]` { length
 * `[and][ColumnsSelectionDsl.and]` age }`
 *
 * <code>`df`</code>`.`[dropNulls][org.jetbrains.kotlinx.dataframe.api.dropNulls]` {
 * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]`(1..5) }`
 *
 * <code>`df`</code>`.`[dropNulls][org.jetbrains.kotlinx.dataframe.api.dropNulls]` {
 * `[colsOf][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.colsOf]`<`[Double][Double]`>()
 ...
 *
 * @param whereAllNull `false` by default. If `true`, rows are dropped if all selected cells are
 *   `null`. If `false`, rows are dropped if any of the selected cells is `null`.
 * @param columns The [Columns Selector][org.jetbrains.kotlinx.dataframe.ColumnsSelector] used to
 *   select the columns of this [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame] to drop rows
 *   in.
 */
@Refine
...
public fun <T> DataFrame<T>.filterNotNull(columns: ColumnsSelector<T, *>): DataFrame<T> =
    dropNulls(columns = columns)
 ...
 * @param whereAllNull `false` by default. If `true`, rows are dropped if all selected cells are
 *   `null`. If `false`, rows are dropped if any of the selected cells is `null`.
 * @param columns The [KProperties][KProperty] used to select the columns of this
 *   [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame] to drop rows in.
 */
@Deprecated(DEPRECATED_ACCESS_API)
@AccessApiOverload
public fun <T> DataFrame<T>.dropNulls(
 ...
 * @param whereAllNull `false` by default. If `true`, rows are dropped if all selected cells are
 *   `null`. If `false`, rows are dropped if any of the selected cells is `null`.
 * @param columns The [Strings][String] corresponding to the names of columns in this
 *   [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame] to drop rows in.
 */
public fun <T> DataFrame<T>.dropNulls(
 ...
 *   `null`. If `false`, rows are dropped if any of the selected cells is `null`.
 * @param columns The [Column References][org.jetbrains.kotlinx.dataframe.columns.ColumnReference]
 *   used to select the columns of this [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame] to
 *   drop rows in.
 */
@Deprecated(DEPRECATED_ACCESS_API)
@AccessApiOverload
 ...
 *
 * Removes rows with [`NA`][org.jetbrains.kotlinx.dataframe.documentation.NA] values. Specific case
 * of [drop][org.jetbrains.kotlinx.dataframe.DataFrame.drop].
 *
 * Optionally, you can select which columns to operate on (see
 * [Selecting Columns][org.jetbrains.kotlinx.dataframe.api.DropNA.DropNASelectingOptions]). Also,
 * you can supply `whereAllNA = true` to only drop rows where all selected cells are
 * [`NA`][org.jetbrains.kotlinx.dataframe.documentation.NA]. By default, rows are dropped if any of
 * the selected cells are [`NA`][org.jetbrains.kotlinx.dataframe.documentation.NA].
 *
 * For more information:
 ...
 * #### For example:
 *
 * <code>`df`</code>`.`[dropNA][org.jetbrains.kotlinx.dataframe.api.dropNA]` { length
 * `[and][ColumnsSelectionDsl.and]` age }`
 *
 * <code>`df`</code>`.`[dropNA][org.jetbrains.kotlinx.dataframe.api.dropNA]` {
 * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]`(1..5) }`
 *
 * <code>`df`</code>`.`[dropNA][org.jetbrains.kotlinx.dataframe.api.dropNA]` {
 * `[colsOf][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.colsOf]`<`[Double][Double]`>()
 ...
 *
 * @param whereAllNA `false` by default. If `true`, rows are dropped if all selected cells are
 *   [`NA`][org.jetbrains.kotlinx.dataframe.documentation.NA]. If `false`, rows are dropped if any
 *   of the selected cells is [`NA`][org.jetbrains.kotlinx.dataframe.documentation.NA].
 * @param columns The [Columns Selector][org.jetbrains.kotlinx.dataframe.ColumnsSelector] used to
 *   select the columns of this [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame] to drop rows
 *   in.
 */
 ...
 * #### For example:
 *
 * <code>`df`</code>`.`[dropNA][org.jetbrains.kotlinx.dataframe.api.dropNA]`("length", "age")`
 *
...
public fun <T> DataColumn<T?>.dropNA(): DataColumn<T> =
    when (typeClass) {
        Double::class,
        Float::class -> filter { !it.isNA }.cast()
 ...
 *
 * Removes rows with [`NaN`][Double.isNaN] values. Specific case of
 * [drop][org.jetbrains.kotlinx.dataframe.DataFrame.drop].
 *
 * Optionally, you can select which columns to operate on (see
 * [Selecting Columns][org.jetbrains.kotlinx.dataframe.api.DropNaNs.DropNaNsSelectingOptions]).
 * Also, you can supply `whereAllNaN = true` to only drop rows where all selected cells are
 * [`NaN`][Double.isNaN]. By default, rows are dropped if any of the selected cells are
 * [`NaN`][Double.isNaN].
 *
 * For more information:
 ...
 * #### For example:
 *
 * <code>`df`</code>`.`[dropNaNs][org.jetbrains.kotlinx.dataframe.api.dropNaNs]` { length
 * `[and][ColumnsSelectionDsl.and]` age }`
 *
 * <code>`df`</code>`.`[dropNaNs][org.jetbrains.kotlinx.dataframe.api.dropNaNs]` {
 * `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]`(1..5) }`
 *
 * <code>`df`</code>`.`[dropNaNs][org.jetbrains.kotlinx.dataframe.api.dropNaNs]` {
 * `[colsOf][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.colsOf]`<`[Double][Double]`>()
 ...
 *
 * @param whereAllNaN `false` by default. If `true`, rows are dropped if all selected cells are
 *   [`NaN`][Double.isNaN]. If `false`, rows are dropped if any of the selected cells is
 *   [`NaN`][Double.isNaN].
 * @param columns The [Columns Selector][org.jetbrains.kotlinx.dataframe.ColumnsSelector] used to
 *   select the columns of this [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame] to drop rows
 *   in.
...
public fun <T> DataColumn<T>.dropNaNs(): DataColumn<T> =
    when (typeClass) {
        Double::class,
        Float::class -> filter { !it.isNaN }.cast()
        else -> this
    }
