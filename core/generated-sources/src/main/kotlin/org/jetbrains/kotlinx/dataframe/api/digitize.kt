...
public fun DataColumn<Double>.digitize(vararg bins: Int, right: Boolean = false): DataColumn<Int> =
    digitize(bins.toList(), Double::class, right)

public fun <T : Comparable<T>> DataColumn<T>.digitize(vararg bins: T, right: Boolean = false): DataColumn<Int> =
    digitize(bins.toList(), right)

public fun <T : Comparable<T>> DataColumn<T>.digitize(
    bins: List<Int>,
    kclass: KClass<T>,
    right: Boolean = false,
): DataColumn<Int> = digitize(
