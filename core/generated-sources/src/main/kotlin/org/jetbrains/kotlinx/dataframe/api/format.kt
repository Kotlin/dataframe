 ...
 * [See `format` on the documentation website.](https://kotlin.github.io/dataframe/format.html)
 */
internal interface FormatDocs {
     ...
     * #### For example:
     *
     * <code>`df`</code>`.`[format][org.jetbrains.kotlinx.dataframe.api.format]` { length
     * `[and][ColumnsSelectionDsl.and]` age }`
     *
     * <code>`df`</code>`.`[format][org.jetbrains.kotlinx.dataframe.api.format]` {
     ...
     * ### Definitions:
     * `cellFormatter:
     * `[FormattingDsl][org.jetbrains.kotlinx.dataframe.api.FormatDocs.Grammar.FormattingDslGrammarDef]`.(cell:
     * C) -> `[CellAttributes][org.jetbrains.kotlinx.dataframe.api.CellAttributes]`?`
     *
     * &nbsp;&nbsp;&nbsp;&nbsp;
     *
     * `rowColFormatter:
     * `[FormattingDsl][org.jetbrains.kotlinx.dataframe.api.FormatDocs.Grammar.FormattingDslGrammarDef]`.(row:
     * `[DataRow][org.jetbrains.kotlinx.dataframe.DataRow]`<T>, col:
     * `[ColumnWithPath][org.jetbrains.kotlinx.dataframe.columns.ColumnWithPath]`<C>) ->
     * `[CellAttributes][org.jetbrains.kotlinx.dataframe.api.CellAttributes]`?`
     *
     * ### Notation:
     *
     * [**format**][org.jetbrains.kotlinx.dataframe.DataFrame.format]**` {
     * `**[`columns`][org.jetbrains.kotlinx.dataframe.documentation.SelectingColumns]**` }`**
     *
     * &nbsp;&nbsp;&nbsp;&nbsp; `[
     * `__`.`__[**`where`**][org.jetbrains.kotlinx.dataframe.api.FormatClause.where]**` {
     * `**[`filter`][org.jetbrains.kotlinx.dataframe.documentation.SelectingRows.RowValueCondition]`:
     * `[`RowValueFilter`][org.jetbrains.kotlinx.dataframe.RowValueFilter]**` } `**`]`
     *
     * &nbsp;&nbsp;&nbsp;&nbsp; `[
     * `__`.`__[**`at`**][org.jetbrains.kotlinx.dataframe.api.FormatClause.at]**`(`**`rowIndices:
     ...
     *
     * &nbsp;&nbsp;&nbsp;&nbsp;
     * __`.`__[**`with`**][org.jetbrains.kotlinx.dataframe.api.FormatClause.with]**` {
     * `**[cellFormatter][org.jetbrains.kotlinx.dataframe.api.FormatDocs.Grammar.CellFormatterDef]**`
     * }`**
     *
     * &nbsp;&nbsp;&nbsp;&nbsp; `|
     * `__`.`__[**`notNull`**][org.jetbrains.kotlinx.dataframe.api.FormatClause.notNull]**` {
     ...
     * `**[rowColFormatter][org.jetbrains.kotlinx.dataframe.api.FormatDocs.Grammar.RowColFormatterDef]**`
     * }`**
     *
     * &nbsp;&nbsp;&nbsp;&nbsp; `|
     * `__`.`__[**`linearBg`**][org.jetbrains.kotlinx.dataframe.api.FormatClause.linearBg]**`(`**`from:
     * `[Pair][Pair]`<`[Number][Number]`,
     * `[RgbColor][org.jetbrains.kotlinx.dataframe.api.RgbColor]`>`**`,`**` to:
     * `[Pair][Pair]`<`[Number][Number]`,
     * `[RgbColor][org.jetbrains.kotlinx.dataframe.api.RgbColor]`>`**`)`**
     *
     ...
     *
     * [cellAttributes][org.jetbrains.kotlinx.dataframe.api.FormatDocs.Grammar.CellAttributesDef]`
     * `[**`and`**][org.jetbrains.kotlinx.dataframe.api.CellAttributes.and]`
     * `[cellAttributes][org.jetbrains.kotlinx.dataframe.api.FormatDocs.Grammar.CellAttributesDef]
     *
     * `| `[**`italic`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.italic]` |
     * `[**`bold`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.bold]` |
     * `[**`underline`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.underline]
     *
     * `|
     ...
     *
     * `|
     * `[**`background`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.background]**`(`**`r:
     * `[Short][Short]**`,`**` g: `[Short][Short]**`,`**` b: `[Short][Short]**`)`**
     *
     * `|
     * `[**`linearBg`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.linearBg]**`(`**`value:
     * `[Number][Number]**`,`**` from: `[Pair][Pair]`<`[Number][Number]`,
     * `[RgbColor][org.jetbrains.kotlinx.dataframe.api.RgbColor]`>`**`,`**` to:
     * `[Pair][Pair]`<`[Number][Number]`,
     * `[RgbColor][org.jetbrains.kotlinx.dataframe.api.RgbColor]`>`**`)`**
     *
     ...
     *
     * `| `[**`textColor`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.textColor]**`(`**`r:
     * `[Short][Short]**`,`**` g: `[Short][Short]**`,`**` b: `[Short][Short]**`)`**
     *
     * `| `[**`attr`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.attr]**`(`**`name:
     * `[String][String]**`,`**` value: `[String][String]**`)`**
     *
     * _- Returning [RgbColor][org.jetbrains.kotlinx.dataframe.api.RgbColor]:_
     *
     * [**`black`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.black]` |
     * `[**`white`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.white]` |
     * `[**`green`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.green]` |
     * `[**`red`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.red]` |
     * `[**`blue`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.blue]` |
     * `[**`gray`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.gray]` |
     * `[**`darkGray`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.darkGray]` |
     * `[**`lightGray`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.lightGray]
     *
     * `| `[**`rgb`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.rgb]**`(`**`r:
     * `[Short][Short]**`,`**` g: `[Short][Short]**`,`**` b: `[Short][Short]**`)`**
     *
     * `| `[**`linear`**][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.linear]**`(`**`value:
     * `[Number][Number]**`,`**` from: `[Pair][Pair]`<`[Number][Number]`,
     * `[RgbColor][org.jetbrains.kotlinx.dataframe.api.RgbColor]`>`**`,`**` to:
     * `[Pair][Pair]`<`[Number][Number]`,
     * `[RgbColor][org.jetbrains.kotlinx.dataframe.api.RgbColor]`>`**`)`**
    ...
    interface Grammar {
         ...
         * `cellFormatter:
         * `[FormattingDsl][org.jetbrains.kotlinx.dataframe.api.FormatDocs.Grammar.FormattingDslGrammarDef]`.(cell:
         * C) -> `[CellAttributes][CellAttributes]`?`
         */
         ...
         * `rowColFormatter:
         * `[FormattingDsl][org.jetbrains.kotlinx.dataframe.api.FormatDocs.Grammar.FormattingDslGrammarDef]`.(row:
         * `[DataRow][DataRow]`<T>, col: `[ColumnWithPath][ColumnWithPath]`<C>) ->
 ...
 * attributes applied to them when rendering the dataframe to HTML.
 *
 * This function does not immediately produce a
 * [FormattedFrame][org.jetbrains.kotlinx.dataframe.api.FormattedFrame], but instead it selects the
 * columns to be formatted and returns a
 * [FormatClause][org.jetbrains.kotlinx.dataframe.api.FormatClause] which serves as an intermediate
 * step.
 *
 * This can include [column groups][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup] and nested
 * columns.
 ...
 *
 * The [FormatClause][org.jetbrains.kotlinx.dataframe.api.FormatClause] allows to further narrow
 * down the selection to individual cells by selecting only certain rows, using
 * [where][org.jetbrains.kotlinx.dataframe.api.FormatClause.where], and then finally specify how to
 * format the cells using [with][org.jetbrains.kotlinx.dataframe.api.FormatClause.with],
 * [perRowCol][org.jetbrains.kotlinx.dataframe.api.FormatClause.perRowCol], or
 * [linearBg][org.jetbrains.kotlinx.dataframe.api.FormatClause.linearBg].
 *
 * You can continue formatting the
 * [FormattedFrame][org.jetbrains.kotlinx.dataframe.api.FormattedFrame] by calling
 * [format][org.jetbrains.kotlinx.dataframe.api.FormattedFrame.format] on it again.
 *
 * Specifying a [column group][org.jetbrains.kotlinx.dataframe.columns.ColumnGroup] makes all of its
 * inner columns be formatted in the same way unless overridden.
 *
 * Formatting is done additively, meaning you can add more formatting to a cell that's already
 * formatted or override certain attributes inherited from its outer group.
 *
 * Specifying a [frame column][org.jetbrains.kotlinx.dataframe.columns.FrameColumn] at the moment
 * does nothing ([Issue #1375](https://github.com/Kotlin/dataframe/issues/1375)), convert each
 * nested [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame] to a
 * [FormattedFrame][org.jetbrains.kotlinx.dataframe.api.FormattedFrame] instead:
 * ```kt
 * df.convert { myFrameCol }.with {
 *     it.format { someCol }.with { background(green) }
 * }.toStandaloneHtml()
 ...
 *
 * You need to specify [formatter]: A lambda function expecting a
 * [CellAttributes][org.jetbrains.kotlinx.dataframe.api.CellAttributes] or `null` given an instance
 * of [DataRow][org.jetbrains.kotlinx.dataframe.DataRow]`<`[T][T]`>` and
 * [ColumnWithPath][org.jetbrains.kotlinx.dataframe.columns.ColumnWithPath]`<`[C][C]`>`.
 *
 * This is similar to a [RowColumnExpression][org.jetbrains.kotlinx.dataframe.RowColumnExpression],
 * except that you also have access to the
 * [FormattingDsl][org.jetbrains.kotlinx.dataframe.api.FormattingDsl] in the context.
 *
 * The formatting DSL allows you to create and combine
 * [CellAttributes][org.jetbrains.kotlinx.dataframe.api.CellAttributes] to apply to one or multiple
 ...
 *
 * [background][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.background]`(`[white][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.white]`)
 * `[and][org.jetbrains.kotlinx.dataframe.api.CellAttributes.and]` `
 * [textColor][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.textColor]`(`[black][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.black]`)
 * `[and][org.jetbrains.kotlinx.dataframe.api.CellAttributes.and]` `
 * [bold][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.bold]
 *
 * It's also possible to define your own colors using
 * [rgb][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.rgb] or interpolate colors using
 * [linear][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.linear].
 *
 * Use [attr][org.jetbrains.kotlinx.dataframe.api.FormattingDsl.attr] if you want to specify a
 ...
 * You need to specify [formatter]: A lambda function expecting a
 * [CellAttributes][org.jetbrains.kotlinx.dataframe.api.CellAttributes] or `null` given an instance
 * of a cell: [C] of the dataframe.
 *
 * You have access to the [FormattingDsl][org.jetbrains.kotlinx.dataframe.api.FormattingDsl] in the
 * context.
 *
 * The formatting DSL allows you to create and combine
 * [CellAttributes][org.jetbrains.kotlinx.dataframe.api.CellAttributes] to apply to one or multiple
