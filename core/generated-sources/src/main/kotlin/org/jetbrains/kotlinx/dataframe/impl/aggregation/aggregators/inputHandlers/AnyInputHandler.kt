 ...
 */
internal class AnyInputHandler<in Value : Any, out Return : Any?> :
     ...
     * [aggregate], this function can be called to calculate it in terms of inheritance by combining
     * the set of known [valueTypes].
     */
    override fun calculateValueType(valueTypes: Set<KType>): ValueType =
        valueTypes.commonType(false).toValueType()

    /**
     * WARNING: HEAVY!
     *
     * If the specific [ValueType] of the input is not known, but you still want to call
     * [aggregate], this function can be called to calculate it in terms of inheritance by getting
     * the types of [values] at runtime. This is heavy because it uses reflection on each value.
     */
