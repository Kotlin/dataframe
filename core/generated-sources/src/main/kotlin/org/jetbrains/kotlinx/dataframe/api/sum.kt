 ...
 * ```
 *
 * @param [columns] The names of the columns of this [<code>DataFrame</code>][org.jetbrains.kotlinx.dataframe.DataFrame] to compute the sum of.
 *
 *
 * @param [skipNaN] If `true`, [<code>`NaN`</code>][org.jetbrains.kotlinx.dataframe.documentation.NaN] values are ignored, just like `null` values.
 *   If `false` (the default), a [<code>`NaN`</code>][org.jetbrains.kotlinx.dataframe.documentation.NaN] in the input is propagated to the result.
 ...
 * ```
 *
 * @param [columns] The [<code>ColumnsSelector</code>][org.jetbrains.kotlinx.dataframe.ColumnsSelector] used to select the columns of this [<code>DataFrame</code>][org.jetbrains.kotlinx.dataframe.DataFrame]
 *   to compute the sum of.
