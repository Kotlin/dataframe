 ...
 * see [number unification][org.jetbrains.kotlinx.dataframe.documentation.UnifyingNumbers].
 * Big numbers ([`BigInteger`][java.math.BigInteger], [`BigDecimal`][java.math.BigDecimal]) are not
 * supported; [`convert`][org.jetbrains.kotlinx.dataframe.DataFrame.convert] them to a primitive number type first.
 *
 *
 *
 ...
 *
 * For more information about the resulting types: [See "`sum` Type Conversion" on the documentation website.](https://kotlin.github.io/dataframe/sum.html#type-conversion)
 *
 * ### Sum Modes
 *
...
internal interface SumDocs : CommonStatisticsDocs {
     ...
     * #### For example:
     *
     * <code>`df`</code>`.`[sum][org.jetbrains.kotlinx.dataframe.api.sum]` { length `[and][ColumnsSelectionDsl.and]` age }`
     *
     * <code>`df`</code>`.`[sum][org.jetbrains.kotlinx.dataframe.api.sum]`  {  `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]`(1..5) }`
     *
     * <code>`df`</code>`.`[sum][org.jetbrains.kotlinx.dataframe.api.sum]`  {  `[colsOf][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.colsOf]`<`[Double][Double]`>() }`
     *
     *
     *
     ...
     * #### For example:
     *
     * <code>`df`</code>`.`[sum][org.jetbrains.kotlinx.dataframe.api.sum]`("length", "age")`
     *
     *
     *
     */
     ...
     * #### For example:
     *
     * <code>`df`</code>`.`[sumFor][org.jetbrains.kotlinx.dataframe.api.sumFor]` { length `[and][ColumnsSelectionDsl.and]` age }`
     *
     * <code>`df`</code>`.`[sumFor][org.jetbrains.kotlinx.dataframe.api.sumFor]`  {  `[cols][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.cols]`(1..5) }`
     *
     * <code>`df`</code>`.`[sumFor][org.jetbrains.kotlinx.dataframe.api.sumFor]`  {  `[colsOf][org.jetbrains.kotlinx.dataframe.api.ColumnsSelectionDsl.colsOf]`<`[Double][Double]`>() }`
     *
     *
     *
     * > There's also a 'single column' variant used sometimes: [Column Selection DSL][org.jetbrains.kotlinx.dataframe.documentation.SelectingColumns.ColumnSelectionDsl.ColumnsSelectionDslWithExample].
     ...
     * #### For example:
     *
     * <code>`df`</code>`.`[sumFor][org.jetbrains.kotlinx.dataframe.api.sumFor]`("length", "age")`
     *
     *
     *
     */
 ...
 *
 * See also:
 * - [`sumOf`][org.jetbrains.kotlinx.dataframe.DataColumn.sumOf] — the sum of the values a selector returns for each element.
 * - [`mean`][org.jetbrains.kotlinx.dataframe.DataColumn.mean] — the sum divided by the number of values.
 * - [`cumSum`][org.jetbrains.kotlinx.dataframe.DataColumn.cumSum] — the running sum of the values in this column.
 * - [The Sum Operation][org.jetbrains.kotlinx.dataframe.api.SumDocs] — an overview of all `sum` modes.
 *
 * For more information: [See `sum` on the documentation website.](https://kotlin.github.io/dataframe/sum.html)
 *
 * ### Example
 ...
 *
 * See also:
 * - [`sum`][org.jetbrains.kotlinx.dataframe.DataColumn.sum] — the sum of the values in this column itself.
 * - [`meanOf`][org.jetbrains.kotlinx.dataframe.DataColumn.meanOf] — the sum of those values divided by the number of values.
 * - [The Sum Operation][org.jetbrains.kotlinx.dataframe.api.SumDocs] — an overview of all `sum` modes.
 *
 * For more information: [See `sum` on the documentation website.](https://kotlin.github.io/dataframe/sum.html)
 *
 ...
 *
 * See also:
 * - [`rowSum`][org.jetbrains.kotlinx.dataframe.DataRow.rowSum] — the sum of all the numbers in this row, of any number type.
 * - [`sum`][org.jetbrains.kotlinx.dataframe.DataFrame.sum] — the sum of the values in specific columns of a [DataFrame][org.jetbrains.kotlinx.dataframe.DataFrame].
 * - [The Sum Operation][org.jetbrains.kotlinx.dataframe.api.SumDocs] — an overview of all `sum` modes.
 *
 * For more information: [See "Row statistics" on the documentation website.](https://kotlin.github.io/dataframe/rowstats.html)
 *
