...
/**
 * The multiple columns handler, which specifies how to aggregate multiple columns into a single
 * value by using the supplied [AggregatorAggregationHandler]. It can also calculate the return type
 * of the aggregation given all input column types.
 */
