...
public fun DataColumn<Number?>.std(skipNaN: Boolean = skipNaN_default, ddof: Int = ddof_default): Double =
...
public fun AnyRow.rowStd(skipNaN: Boolean = skipNaN_default, ddof: Int = ddof_default): Double =
...
public fun <T> DataFrame<T>.std(skipNaN: Boolean = skipNaN_default, ddof: Int = ddof_default): DataRow<T> =
...
public fun <T> Grouped<T>.std(skipNaN: Boolean = skipNaN_default, ddof: Int = ddof_default): DataFrame<T> =
