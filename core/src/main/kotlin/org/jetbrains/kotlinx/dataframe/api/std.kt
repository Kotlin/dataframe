...
internal interface StdDocs : CommonStatisticsDocs {
     ...
     * To include those in the standard deviation, [flatten][DataFrame.flatten] the DataFrame first.
     */
    @ExcludeFromSources
    typealias AllSuitableColumnsSnippet = Nothing

    /**
     * {@comment The documentation website links all [Grouped] `std` KDocs end with. KDoc-snippet.}
     *
    ...
    /**
     * {@comment The documentation website links all [Pivot] and [PivotGroupBy] `std` KDocs end with.
     *    KDoc-snippet.}
     *
     ...
     *
     * @param [columns\] The [ColumnsSelector] used to select the columns to compute the standard deviation of.
     */
    @ExcludeFromSources
    ...
    /**
     * @comment The `expression` parameter of the `stdOf` overloads. KDoc-snippet.
     *
     * @param [expression\] The [RowExpression] to compute the value to include for each row.
     */
    @ExcludeFromSources
    typealias ExpressionParam = Nothing

    /**
     * @comment The `name` parameter of the [Grouped.std] overloads. KDoc-snippet.
     *
 ...
 * ```
 *
 * @param [T] The type of the values to include. Only columns of this type are taken into account.
 * @include [StdDocs.SkipNanParam]
 * @include [StdDocs.DdofParam]
 ...
 * ```
 *
 * @param [name] The name of the resulting column. If `null` (the default), `"std"` is used.
 *   This name needs to be unique, else a [DuplicateColumnPathInsertException] is thrown.
 * @include [StdDocs.SkipNanParam]
 * @include [StdDocs.DdofParam]
 * @include [StdDocs.ExpressionParam]
