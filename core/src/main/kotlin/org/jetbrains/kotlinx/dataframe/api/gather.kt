...
internal interface GatherDocs {
     ...
     * }`**
     *
     * {@include [Indent]} `\[ `__`.`__[**`explodeLists`**][Gather.explodeLists]**`() `**`]`
     *
     * {@include [Indent]} `\[ `__`.`__[**`cast`**][Gather.cast]**`<T>() `**`]`
     *
     * {@include [Indent]} `\[ `__`.`__[**`notNull`**][Gather.cast]**`() `**`]`
     *
     * {@include [Indent]} `\[ `__`.`__[**`where`**][Gather.where]**` { `**`filter:
     * `[`RowValueFilter`][RowValueFilter]**` } `**`]`
     *
     * {@include [Indent]} `\[ `__`.`__[**`mapKeys`**][Gather.mapKeys]**` { `**`transform:
     * (`[`String`][String]**`) -> K } `**`]`
     *
     * {@include [Indent]} `\[ `__`.`__[**`mapValues`**][Gather.mapValues]**` { `**`transform:
     * (`**`C`**`) -> R`**` } `**`]`
     *
     * {@include [Indent]} __`.`__[**`into`**][Gather.into]**`(`**`keyColumn:
     * `[`String`][String]**`, `**`valueColumn: `[`String`][String]**`)`**
     *
     * {@include [Indent]} `| `__`.`__[**`keysInto`**][Gather.keysInto]**`(`**`keyColumn:
     * `[`String`][String]**`)`**
     *
     * {@include [Indent]} `| `__`.`__[**`valuesInto`**][Gather.valuesInto]**`(`**`valueColumn:
     * `[`String`][String]**`)`**
     */
