...
public interface ValueColColumnsSelectionDsl<out _UNUSED> {
     ...
     * inside a [ColumnGroup]. {@include [LineBreak]} {@get [CommonValueColDocs.NOTE]}
     *
     * ### Check out: [Grammar]
     *
     * #### For example:
    ...
    private interface CommonValueColDocs {
        ...
        /**
         * `df.`[select][DataFrame.select]` { {@get
         * [CommonValueColDocs.RECEIVER]}`[valueCol][valueCol]`({@get [CommonValueColDocs.ARG]}) \}`
         */
         ...
         *
         * `df.`[select][DataFrame.select]` { {@get
         * [CommonValueColDocs.RECEIVER]}`[valueCol][valueCol]`<`[String][String]`>({@get
         * [CommonValueColDocs.ARG]}) \}`
         */
     ...
     * @include [CommonValueColDocs] {@set [CommonValueColDocs.ARG] valueColumnA} {@set
     *   [CommonValueColDocs.EXAMPLE] {@include [CommonValueColDocs.SingleExample]}}
     ...
     * @include [CommonValueColDocs] {@set [CommonValueColDocs.ARG] "valueColumnName"} {@set
     *   [CommonValueColDocs.EXAMPLE] {@include [CommonValueColDocs.DoubleExample]}}
     */
     ...
     * @include [CommonValueColDocs] {@set [CommonValueColDocs.ARG] "pathTo"["valueColumnName"\] }
     ...
     * @include [CommonValueColDocs] {@set [CommonValueColDocs.ARG] Type::valueColumnA} {@set
     *   [CommonValueColDocs.EXAMPLE] {@include [CommonValueColDocs.SingleExample]}}
     * @include [CommonValueColDocs.ValueColumnTypeParam]
     */
     ...
     * @include [CommonValueColDocs] {@set [CommonValueColDocs.ARG] 0} {@set
     *   [CommonValueColDocs.EXAMPLE] {@include [CommonValueColDocs.DoubleExample]}}
     */
     ...
     * @include [CommonValueColDocs.ValueColumnTypeParam] {@set [CommonValueColDocs.EXAMPLE]
     *   {@include [CommonValueColDocs.SingleExample]}}
     */
