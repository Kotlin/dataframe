...
/**
 * Implementation of [AggregatorMultipleColumnsHandler] that simply flattens all input columns. This
 * is useful for aggregators that depend on the distribution of values across multiple columns.
 *
...
internal class FlatteningMultipleColumnsHandler<in Value : Any, out Return : Any?> :
    ...
    /**
     * Aggregates the data in the multiple given columns and computes a single resulting value. The
     * columns are flattened into a single list of values; then the aggregation function is called
