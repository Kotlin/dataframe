...
public interface ColsColumnsSelectionDsl<out _UNUSED> {
     ...
     *   [DslGrammarTemplate.ColumnTypeDef]} {@include [LineBreak]} {@include
     *   [DslGrammarTemplate.IndexRangeDef]} {@include [LineBreak]} }
     *
     * {@set [DslGrammarTemplate.PLAIN_DSL_FUNCTIONS] {@include [PlainDslName]}`[`**`<`**{@include
     * [DslGrammarTemplate.ColumnTypeRef]}**`>`**`]`**`(`**{@include
     * [DslGrammarTemplate.ColumnRef]}**`,`**` .. | `{@include
     * [DslGrammarTemplate.IndexRef]}**`,`**` .. | `{@include
     * [DslGrammarTemplate.IndexRangeRef]}**`)`**
     *
     * `| `{@include [PlainDslName]}` [ `**` { `**{@include [DslGrammarTemplate.ConditionRef]}**` \}
     * `**`]`
     *
     * `| `**`this`**`/`**`it `**[**`[`**][cols]**`{ `**{@include
     * [DslGrammarTemplate.ConditionRef]}**` \}`**[**`]`**][cols]
     *
     * `| `**`this`**`/`**`it `**[**`[`**][cols]{@include [DslGrammarTemplate.ColumnRef]}**`,`**` ..
     * `[**`]`**][cols] }
     *
     * {@set [DslGrammarTemplate.COLUMN_SET_FUNCTIONS] {@include [Indent]}{@include
     * [ColumnSetName]}**`(`**{@include [DslGrammarTemplate.IndexRef]}**`,`**` .. | `{@include
     * [DslGrammarTemplate.IndexRangeRef]}**`)`**
     *
     * {@include [Indent]}`| `{@include [ColumnSetName]}` [ `**` { `**{@include
     * [DslGrammarTemplate.ConditionRef]}**` \} `**`]`
     *
     * {@include [Indent]}`| `[**`[`**][cols]**`{ `**{@include [DslGrammarTemplate.ConditionRef]}**`
     * \}`**[**`]`**][cols]
     *
     * {@include [Indent]}`| `[**`[`**][cols]{@include [DslGrammarTemplate.IndexRef]}**`,`**` .. |
     * `{@include [DslGrammarTemplate.IndexRangeRef]}[**`]`**][cols]` }
     *
     ...
     * [DslGrammarTemplate.IndexRangeRef]}**`)`**
     *
     * {@include [Indent]}`| `{@include [ColumnGroupName]}` [ `**` { `**{@include
     * [DslGrammarTemplate.ConditionRef]}**` \} `**`]`
     *
     * {@include [Indent]}`| `[**`[`**][cols]**`{ `**{@include [DslGrammarTemplate.ConditionRef]}**`
     * \}`**[**`]`**][cols]
     *
     * {@include [Indent]}`| `[**`[`**][cols]{@include [DslGrammarTemplate.ColumnRef]}**`,`**`
     * ..`[**`]`**][cols] }
     */
     ...
     *
     * You can use either a [ColumnFilter], or any of the `vararg` overloads for any {@include
     * [AccessApiLink]}. The function can be both typed and untyped (in case you're supplying a
     * column name, -path, or index (range)).
     *
    ...
    private interface CommonColsDocs {
        ...
        /**
         * @param [predicate\] A [ColumnFilter function][ColumnFilter] that takes a
         *   [ColumnReference] and returns a [Boolean].
         ...
         * @param [otherCols\] Optional additional {@get [AccessorType]}s that point to relative
         *   columns.
     ...
     *
     * Retrieves multiple columns from [this\] in the form of a [ColumnSet] by a [range\] of
     * indices. If any of the indices in the [range\] are out of bounds, an
     ...
     * }`[`]`][SingleColumn.cols]` }` {@include [LineBreak]}
     */
    ...
    /**
     * @include [CommonColsDocs.Vararg] {@set [CommonColsDocs.Vararg.AccessorType]
     *   [ColumnReference]}
     * @set [CommonColsDocs.Examples]
     *
