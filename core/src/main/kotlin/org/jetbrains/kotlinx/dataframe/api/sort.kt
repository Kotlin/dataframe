 ...
 * (ascending in [sortBy][DataFrame.sortBy] and descending in [sortByDesc][DataFrame.sortByDesc]).
...
/**
 * Returns the sorted version of the current [ValueColumn], [FrameColumn], or [ColumnGroup] based
 ...
 */
@ExcludeFromSources
private typealias CommonDataColumnSortWithDocsSnippet = Nothing

/** @include [CommonDataColumnSortWithDocsSnippet] */
