...
public interface ColsOfKindColumnsSelectionDsl {
     ...
     *   [DslGrammarTemplate.ColumnKindDef]} }
     *
     ...
     * [ColumnSetName]}**`(`**{@include [DslGrammarTemplate.ColumnKindRef]}**`,`**` ..`**`)`**`
     * [ `**`{ `**{@include [DslGrammarTemplate.ConditionRef]}**` \}`**` ]` }
     *
     * {@set [DslGrammarTemplate.COLUMN_GROUP_FUNCTIONS] {@include [Indent]}{@include
     * [ColumnGroupName]}**`(`**{@include [DslGrammarTemplate.ColumnKindRef]}**`,`**` ..`**`)`**`
     * [ `**`{ `**{@include [DslGrammarTemplate.ConditionRef]}**` \}`**` ]` }
     */
     ...
     *
     * You can optionally use a [filter\] to only include certain columns. [colsOfKind] can be
     * called using any of the supported [APIs][AccessApis] (+ [ColumnPath]).
     *
