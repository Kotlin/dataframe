...
public interface WithoutNullsColumnsSelectionDsl {
     ...
     * }.`[withoutNulls][ColumnSet.withoutNulls]`() }`
     */
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * myColumnGroup.`[colsWithoutNulls][SingleColumn.colsWithoutNulls]`() }`
     */
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * "myColumnGroup".`[colsWithoutNulls][String.colsWithoutNulls]`() }`
     */
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * "pathTo"["myColGroup"].`[colsWithoutNulls][ColumnPath.colsWithoutNulls]`() }`
     */
