...
private fun getCSVType(path: String): CSVType = when (path.substringAfterLast('.').lowercase()) {
    "csv" -> CSVType.DEFAULT
    "tdf" -> CSVType.TDF
...
public fun AnyFrame.toCsv(format: CSVFormat = CSVFormat.DEFAULT): String = StringWriter().use {
