...
/**
 * Returns a [DataColumn] of [Boolean] values indicating whether each element in this column lies
 * between [left] and [right].
 *
 * If [includeBoundaries] is `true` (default), values equal to [left] or [right] are also considered
 * in range.
 *
 * @param left The lower boundary of the range.
 * @param right The upper boundary of the range.
 * @param includeBoundaries Whether to include [left] and [right] values in the range check.
 *   Defaults to `true`.
