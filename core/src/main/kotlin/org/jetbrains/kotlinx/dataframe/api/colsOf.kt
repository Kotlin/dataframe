...
public interface ColsOfColumnsSelectionDsl {
     ...
     * [LineBreak]} {@include [DslGrammarTemplate.SingleColumnDef]} {@include [LineBreak]} {@include
     * [DslGrammarTemplate.ColumnGroupNoSingleColumnDef]} {@include [LineBreak]} {@include
     ...
     * [ColumnSetName]}**`<`**{@include [DslGrammarTemplate.ColumnTypeRef]}**`>`**` [
     * `**`(`**{@include [DslGrammarTemplate.KTypeRef]}**`)`**` ]
     * [ `**`{ `**{@include [DslGrammarTemplate.ConditionRef]}**` \}`**` ]` }
     *
     * {@comment We need to deviate from the template here, since we have overload discrepancies.}
     * {@set [DslGrammarTemplate.COLUMN_GROUP_PART] {@include [LineBreak]}
     *
     ...
     *
     * {@include [Indent]}{@include [ColumnGroupName]}**`<`**{@include
     * [DslGrammarTemplate.ColumnTypeRef]}**`>(`**{@include [DslGrammarTemplate.KTypeRef]}**`)`**`
     * [ `**`{ `**{@include [DslGrammarTemplate.ConditionRef]}**` \}`**` ]` }
     */
     ...
     *
     * `df.`[select][DataFrame.select]` { `[colsOf][ColumnsSelectionDsl.colsOf]`<`[Int][Int]`> {
     * it.`[size][DataColumn.size]` > 10 } }` {@include [LineBreak]} Alternatively, [colsOf] can
     ...
     *
     * `df.`[select][DataFrame.select]` {
     * Type::myColumnGroup.`[colsOf][ColumnsSelectionDsl.colsOf]`<`[Double][Double]`>() }` {@include
     * [LineBreak]} Finally, [colsOf] can also take a [KType] argument instead of a reified type.
     * This is useful when the type is not known at compile time or when the API function cannot be
     * inlined.
