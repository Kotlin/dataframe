...
// region WARNING in 0.11, ERROR in 0.12

private const val message_0_12 = "Was removed in 0.12."

internal const val DF_READ_DEPRECATION_MESSAGE = "Replaced with `unfold` operation. $message_0_12"
internal const val DF_READ_REPLACE_MESSAGE = "this.unfold(*columns)"

internal const val ITERABLE_COLUMNS_DEPRECATION_MESSAGE = "Replaced with `toColumnSet()` operation. $message_0_12"
internal const val ITERABLE_COLUMNS_REPLACE = "update { columns.toColumnSet() }"
...
internal const val DFS_MESSAGE = "dfs is deprecated, use recursively instead. $message_0_13 " +
    "NOTE: This function is actively being worked on and will be replaced again in the future."

internal const val ALL_DFS_MESSAGE = "allDfs is deprecated, use recursively instead. $message_0_13 " +
    "NOTE: This function is actively being worked on and will be replaced again in the future."

internal const val DFS_OF_MESSAGE = "dfsOf is deprecated, use recursively instead. $message_0_13 " +
    "NOTE: This function is actively being worked on and will be replaced again in the future."
