...
/**
 * Functions that can be replaced with existing API such as shortcuts without clean value,
 * or something not properly designed. Can be considered to be removed from API.
