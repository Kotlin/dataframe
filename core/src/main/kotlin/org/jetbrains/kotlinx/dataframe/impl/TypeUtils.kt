...
internal fun KType.projectTo(targetClass: KClass<*>): KType {
    ...
    return when {
        targetClass.typeParameters.isEmpty() || currentClass == null ->
            targetClass.createStarProjectedType(
                isMarkedNullable,
            )
...
internal fun getCommonNumberType(
    first: KClass<*>?,
    second: KClass<*>,
): KClass<*> =
    when {
...
internal fun Iterable<KClass<*>>.createType(
    nullable: Boolean,
