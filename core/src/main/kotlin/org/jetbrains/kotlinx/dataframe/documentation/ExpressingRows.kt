...
internal interface ExpressingRows {
    ...
    /**
     * [with][org.jetbrains.kotlinx.dataframe.api.Update.with] and [add][org.jetbrains.kotlinx.dataframe.api.add] use [AddDataRow] instead of [DataRow] as the DSL's receiver type.
