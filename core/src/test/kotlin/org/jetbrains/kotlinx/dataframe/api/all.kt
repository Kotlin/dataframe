...
class AllTests : ColumnsSelectionDslTests() {
    ...
    fun `all exceptions`() {
        ...
        shouldThrow<IllegalArgumentException> { df.select { "age".allColsBefore("") } }
        shouldThrow<IllegalArgumentException> { df.select { "age".allColsAfter("") } }
        shouldThrow<IllegalArgumentException> { df.select { "age".allColsUpTo("") } }
        shouldThrow<IllegalArgumentException> { df.select { "age".allColsFrom("") } }
    ...
    fun `2 levels deep`() {
        ...
        listOf(
                ...
                dfGroup.select {
                    name.firstName.allColsBefore(pathOf("name", "firstName", "thirdName"))
                },
                ...
                dfGroup.select {
                    name.firstName.allColsUpTo(pathOf("name", "firstName", "secondName"))
                },
            )
            .shouldAllBeEqual()
    }
