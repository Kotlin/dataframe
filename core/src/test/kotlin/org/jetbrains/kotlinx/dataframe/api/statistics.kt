...
class StatisticsTests {
    private val personsDf = dataFrameOf("name", "age", "city", "weight", "height")(
    ...
    fun `median on GroupBy`() {
        ...
        res0.columnNames() shouldBe listOf("city", "name", "age", "height") // TODO: why double values from weight are not in the list? are they not Comparable?
    ...
    fun `min on GroupBy`() {
        ...
        res0.columnNames() shouldBe listOf("city", "name", "age", "height") // TODO: why it's working for height and doesn't work for Double column weight
        ...
        res4.columnNames() shouldBe listOf("city", "name", "age", "weight", "height") // TODO: why is here weight presented? looks like inconsitency
        ...
        res4.columnNames() shouldBe listOf("city", "name", "age", "weight", "height")
    ...
    fun `max on GroupBy`() {
        ...
        res0.columnNames() shouldBe listOf("city", "name", "age", "height") // TODO: DOUBLE weight?
        ...
        res4.columnNames() shouldBe listOf("city", "name", "age", "weight", "height") // TODO: weight is here?
