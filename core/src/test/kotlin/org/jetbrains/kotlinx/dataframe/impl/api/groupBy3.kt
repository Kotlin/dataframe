...
/** Step 3: use scalar map keys when grouping by one column, avoiding a list allocation per row. */
internal fun <T> DataFrame<T>.groupByImpl3(moveToTop: Boolean, columns: ColumnsSelector<T, *>): GroupBy<T, T> {
