...
/** Step 1: build the groups imperatively, avoiding intermediate row-key pairs and collection grouping. */
internal fun <T> DataFrame<T>.groupByImpl1(moveToTop: Boolean, columns: ColumnsSelector<T, *>): GroupBy<T, T> {
