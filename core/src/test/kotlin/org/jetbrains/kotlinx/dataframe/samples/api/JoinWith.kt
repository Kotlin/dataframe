...
class JoinWith : TestBase() {
    ...
    private val coloredVisits =
        dataFrameOf("date", "usedId")(
            ...
            LocalDate(
                ...
                5,
                1,
            ).colored(FormattingDSL.white, FormattingDSL.black),
    ...
    private fun snippetOutput(
        coloredResult: DataFrame<Any?>,
        result: DataFrame<Any?>,
    ) {
