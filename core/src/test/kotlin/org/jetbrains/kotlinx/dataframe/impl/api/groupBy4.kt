...
/** Step 4: construct groups column-first, reading value columns sequentially instead of permuting the whole frame. */
internal fun <T> DataFrame<T>.groupByImpl4(moveToTop: Boolean, columns: ColumnsSelector<T, *>): GroupBy<T, T> {
