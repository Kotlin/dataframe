...
internal class GroupedColumnWithParent<T>(override val parent: GroupedColumnDef?, val source: GroupedColumn<T>) : ColumnDataWithParent<DataFrameRow<T>>, GroupedColumn<T> by source {
