...
public inline fun <T, reified R : Number> DataColumn<T>.meanOf(skipNa: Boolean = false, noinline expression: (T) -> R?): Double = Aggregators.mean(skipNa).cast2<R?, Double>().aggregateOf(this, expression) ?: Double.NaN
