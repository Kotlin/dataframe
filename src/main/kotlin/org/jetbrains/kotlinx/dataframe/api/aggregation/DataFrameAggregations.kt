...
public fun <T, C : Comparable<C>> DataFrame<T>.minFor(columns: AggregateColumnsSelector<T, C?>): DataRow<T> = org.jetbrains.kotlinx.dataframe.impl.aggregation.aggregators.Aggregators.min.aggregateFor(this, columns)
...
public fun <T, C : Comparable<C>> DataFrame<T>.minOrNull(columns: ColumnsSelector<T, C?>): C? = org.jetbrains.kotlinx.dataframe.impl.aggregation.aggregators.Aggregators.min.aggregateAll(this, columns)
...
public fun <T, C : Comparable<C>> DataFrame<T>.maxOrNull(columns: ColumnsSelector<T, C?>): C? = org.jetbrains.kotlinx.dataframe.impl.aggregation.aggregators.Aggregators.max.aggregateAll(this, columns)
...
public fun <T, C : Number> DataFrame<T>.sumFor(columns: AggregateColumnsSelector<T, C?>): DataRow<T> = org.jetbrains.kotlinx.dataframe.impl.aggregation.aggregators.Aggregators.sum.aggregateFor(this, columns)
...
public inline fun <T, reified C : Number> DataFrame<T>.sum(noinline columns: ColumnsSelector<T, C?>): C = org.jetbrains.kotlinx.dataframe.impl.aggregation.aggregators.Aggregators.sum.aggregateAll(this, columns) ?: C::class.zero()
...
public fun <T, C : Number> DataFrame<T>.meanFor(skipNa: Boolean = false, columns: AggregateColumnsSelector<T, C?>): DataRow<T> = org.jetbrains.kotlinx.dataframe.impl.aggregation.aggregators.Aggregators.mean(skipNa).aggregateFor(this, columns)
...
public fun <T, C : Number> DataFrame<T>.mean(skipNa: Boolean = false, columns: ColumnsSelector<T, C?>): Double = org.jetbrains.kotlinx.dataframe.impl.aggregation.aggregators.Aggregators.mean(skipNa).aggregateAll(this, columns) as Double? ?: Double.NaN
...
): Double = org.jetbrains.kotlinx.dataframe.impl.aggregation.aggregators.Aggregators.mean(skipNa).of(this, selector) ?: Double.NaN
...
public fun <T, C : Comparable<C>> DataFrame<T>.medianFor(columns: AggregateColumnsSelector<T, C?>): DataRow<T> = org.jetbrains.kotlinx.dataframe.impl.aggregation.aggregators.Aggregators.median.aggregateFor(this, columns)
...
public fun <T, C : Comparable<C>> DataFrame<T>.medianOrNull(columns: ColumnsSelector<T, C?>): C? = org.jetbrains.kotlinx.dataframe.impl.aggregation.aggregators.Aggregators.median.aggregateAll(this, columns)
...
public inline fun <T, reified R : Comparable<R>> DataFrame<T>.medianOf(crossinline selector: RowSelector<T, R?>): R? = org.jetbrains.kotlinx.dataframe.impl.aggregation.aggregators.Aggregators.median.of(this, selector) as R?
...
public fun <T> DataFrame<T>.stdFor(columns: AggregateColumnsSelector<T, Number?>): DataRow<T> = org.jetbrains.kotlinx.dataframe.impl.aggregation.aggregators.Aggregators.std.aggregateFor(this, columns)
...
public fun <T> DataFrame<T>.std(columns: ColumnsSelector<T, Number?>): Double = aggregateAll(org.jetbrains.kotlinx.dataframe.impl.aggregation.aggregators.Aggregators.std, columns) ?: .0
...
public fun <T> DataFrame<T>.stdOf(selector: RowSelector<T, Number?>): Double = org.jetbrains.kotlinx.dataframe.impl.aggregation.aggregators.Aggregators.std.aggregateOf(this, selector) ?: .0
