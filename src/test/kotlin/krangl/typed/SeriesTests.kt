...
class SeriesTests {
    ...
    val TypedDataFrame<Weather>.city get() = this["city"] as ColumnDef<String>
    val TypedDataFrame<Weather>.day get() = this["day"] as ColumnDef<Int>
    val TypedDataFrame<Weather>.temp get() = this["temp"] as ColumnDef<Int>
