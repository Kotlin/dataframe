...
class DuckDbTest {
    ...
    data class Person(
        ...
        val age: Int,
        val salary: Double,
        @ColumnName("hire_date") val hireDate: LocalDate,
    ) {
        companion object {
            val expected =
                listOf(
    ...
    @DataSchema data class SomeJson(val key: String)

    @DataSchema
    data class GeneralPurposeTypes(
        @ColumnName("bigint_col") val bigintCol: Long,
        @ColumnName("binary_col") val binaryCol: Blob,
        @ColumnName("bit_col") val bitCol: String,
        @ColumnName("bitstring_col") val bitstringCol: String,
        @ColumnName("blob_col") val blobCol: Blob,
        @ColumnName("bool_col") val boolCol: Boolean,
        @ColumnName("boolean_col") val booleanCol: Boolean,
        @ColumnName("bpchar_col") val bpcharCol: String,
        @ColumnName("bytea_col") val byteaCol: Blob,
        @ColumnName("char_col") val charCol: String,
        @ColumnName("date_col") val dateCol: LocalDate,
        @ColumnName("datetime_col") val datetimeCol: Instant,
        @ColumnName("decimal_col") val decimalCol: BigDecimal,
        @ColumnName("double_col") val doubleCol: Double,
        @ColumnName("enum_col") val enumCol: String,
        @ColumnName("float4_col") val float4Col: Float,
        @ColumnName("float8_col") val float8Col: Double,
        @ColumnName("float_col") val floatCol: Float,
        @ColumnName("hugeint_col") val hugeintCol: BigInteger,
        @ColumnName("int128_col") val int128Col: BigInteger,
        @ColumnName("int16_col") val int16Col: Short,
        @ColumnName("int1_col") val int1Col: Byte,
        @ColumnName("int2_col") val int2Col: Short,
        @ColumnName("int32_col") val int32Col: Int,
        @ColumnName("int4_col") val int4Col: Int,
        @ColumnName("int64_col") val int64Col: Long,
        @ColumnName("int8_col") val int8Col: Long,
        @ColumnName("int_col") val intCol: Int,
        @ColumnName("integer_col") val integerCol: Int,
        @ColumnName("interval_col") val intervalCol: String,
        @ColumnName("json_col") val jsonCol: SomeJson,
        @ColumnName("logical_col") val logicalCol: Boolean,
        @ColumnName("long_col") val longCol: Long,
        @ColumnName("numeric_col") val numericCol: BigDecimal,
        @ColumnName("real_col") val realCol: Float,
        @ColumnName("short_col") val shortCol: Short,
        @ColumnName("signed_col") val signedCol: Int,
        @ColumnName("smallint_col") val smallintCol: Short,
        @ColumnName("string_col") val stringCol: String,
        @ColumnName("text_col") val textCol: String,
        @ColumnName("time_col") val timeCol: LocalTime,
        @ColumnName("timestamp_col") val timestampCol: Instant,
        @ColumnName("timestamptz_col") val timestamptzCol: JavaOffsetDateTime,
        @ColumnName("timestampwtz_col") val timestampwtzCol: JavaOffsetDateTime,
        @ColumnName("tinyint_col") val tinyintCol: Byte,
        @ColumnName("ubigint_col") val ubigintCol: BigInteger,
        @ColumnName("uhugeint_col") val uhugeintCol: BigInteger,
        @ColumnName("uint128_col") val uint128Col: BigInteger,
        @ColumnName("uint16_col") val uint16Col: Int,
        @ColumnName("uint32_col") val uint32Col: Long,
        @ColumnName("uint64_col") val uint64Col: BigInteger,
        @ColumnName("uint8_col") val uint8Col: Short,
        @ColumnName("uint_col") val uintCol: Long,
        @ColumnName("usmallint_col") val usmallintCol: Int,
        @ColumnName("utinyint_col") val utinyintCol: Short,
        @ColumnName("uuid_col") val uuidCol: Uuid,
        @ColumnName("varbinary_col") val varbinaryCol: Blob,
        @ColumnName("varchar_col") val varcharCol: String,
    ) {
        companion object {
            val expected =
                listOf(
                        GeneralPurposeTypes(
                            ...
                            binaryCol =
                                DuckDBResultSet.DuckDBBlobResult(
                                    ByteBuffer.wrap("DEADBEEF".toByteArray())
                                ),
                            bitCol = "1010",
                            bitstringCol = "1010",
                            blobCol =
                            ...
                            datetimeCol =
                                Timestamp.valueOf("2025-06-19 12:34:56")
                                    .toInstant()
                                    .toKotlinInstant(),
    ...
    @DataSchema data class NestedEntry(val i: Int, val j: String) : DataRowSchema

    @DataSchema data class NullableNestedEntry(val i: Int?, val j: String?) : DataRowSchema

    @DataSchema
    data class NestedTypes(
        @ColumnName("test_col") val testCol: Int,
        @ColumnName("ijstruct_col") val ijstructCol: NestedEntry,
        @ColumnName("ijstructlist_col") val ijstructlistCol: DataFrame<NullableNestedEntry>,
        @ColumnName("intarray_col") val intarrayCol: List<Int?>,
        @ColumnName("intlist_col") val intlistCol: List<Int?>,
        @ColumnName("intstringmap_col") val intstringmapCol: Map<Int, String?>,
        @ColumnName("intstrinstinggmap_col")
        val intstrinstinggmapCol: Map<Int, Map<String, String?>?>,
        @ColumnName("stringarray_col") val stringarrayCol: List<String?>,
        @ColumnName("stringlist_col") val stringlistCol: List<String?>,
        @ColumnName("stringlistlist_col") val stringlistlistCol: List<List<String?>?>,
        @ColumnName("union_col") val unionCol: Any,
    )
        ...
        DriverManager.getConnection(URL).use { connection ->
            ...
            subset =
                DataFrame.readSqlQuery(
                    connection,
                    """SELECT test_table.name, test_table.age FROM test_table""",
                )
        }
    ...
    fun `read each general-purpose DuckDB type`() {
        ...
        // on some systems OffsetDateTime's get converted to UTC sometimes, let's compare them as
        // Instant instead
        fun AnyFrame.fixOffsetDateTime() =
            convert { colsOf<JavaOffsetDateTime>() }.with { it.toInstant() }
    ...
    fun `read each nested DuckDB type`() {
        ...
        df.single().let {
            ...
            it["intstrinstinggmap_col"] shouldBe
                mapOf(
            ...
            it[{ "ijstructlist_col"<DataFrame<NestedEntry>>() }] shouldBe
                dataFrameOf(NestedEntry(42, "answer"), NestedEntry(44, "answer"))
        ...
        try {
            ...
            DriverManager.getConnection("jdbc:duckdb:${dbPath.toAbsolutePath()}").use { connection
                ...
                connection.createStatement().use { st ->
                    st.executeUpdate(
                        "CREATE TABLE test_data(col1 INTEGER, col2 INTEGER, col3 INTEGER)"
                    )
            ...
            val config =
                DbConnectionConfig("jdbc:duckdb:${dbPath.toAbsolutePath()}", readOnly = true)
    ...
    fun `parse Struct types`() {
        DuckDb.parseStructType("STRUCT(v VARCHAR, i INTEGER)") shouldBe
            mapOf("v" to "VARCHAR", "i" to "INTEGER")
        DuckDb.parseStructType("STRUCT(col1 MAP(INTEGER, VARCHAR), col2 INTEGER)") shouldBe
            mapOf("col1" to "MAP(INTEGER, VARCHAR)", "col2" to "INTEGER")
        DuckDb.parseStructType("STRUCT(col1 STRUCT(i INTEGER, j VARCHAR), col2 INTEGER)") shouldBe
            mapOf("col1" to "STRUCT(i INTEGER, j VARCHAR)", "col2" to "INTEGER")
        DuckDb.parseStructType("STRUCT(col1 INTEGER[], col2 VARCHAR[][])") shouldBe
            mapOf("col1" to "INTEGER[]", "col2" to "VARCHAR[][]")
    }

    @Test
    fun `parse Map types`() {
        DuckDb.parseMapTypes("MAP(INTEGER, VARCHAR)") shouldBe ("INTEGER" to "VARCHAR")
        DuckDb.parseMapTypes("MAP(INTEGER, MAP(VARCHAR, VARCHAR))") shouldBe
            ("INTEGER" to "MAP(VARCHAR, VARCHAR)")
        DuckDb.parseMapTypes("MAP(STRUCT(i INTEGER, j VARCHAR), VARCHAR)") shouldBe
            ("STRUCT(i INTEGER, j VARCHAR)" to "VARCHAR")
    }
    ...
    fun `parse List types`() {
        ...
        DuckDb.parseListType("STRUCT(i INTEGER, j VARCHAR)[]") shouldBe
