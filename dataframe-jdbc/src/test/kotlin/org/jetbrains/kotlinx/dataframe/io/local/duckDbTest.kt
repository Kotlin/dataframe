...
class DuckDbTest {
    ...
    fun `read simple dataframe from DuckDB`() {
        ...
        DriverManager.getConnection(URL).use { connection ->
            ...
            schema = DataFrameSchema.fromSqlTable(connection, "test_table")
    ...
    fun `read simple dataframe from DuckDB ResultSet`() {
        ...
        DriverManager.getConnection(URL).use { connection ->
            ...
            connection.prepareStatement("SELECT * FROM test_table").executeQuery().use { rs ->
                ...
                schema = DataFrameSchema.fromResultSet(rs, DuckDb)
            }
        }
    ...
    fun `read all tables`() {
        ...
        DriverManager.getConnection(URL).use { connection ->
            ...
            schemas = DataFrameSchema.fromAllSqlTables(connection = connection)
        }
    ...
    fun `read each general-purpose DuckDB type`() {
        ...
        DriverManager.getConnection(URL).use { connection ->
            ...
            schema = DataFrameSchema.fromSqlTable(connection, "table1")
    ...
    fun `read each nested DuckDB type`() {
        ...
        DriverManager.getConnection(URL).use { connection ->
            ...
            schema = DataFrameSchema.fromSqlTable(connection, "table2")
