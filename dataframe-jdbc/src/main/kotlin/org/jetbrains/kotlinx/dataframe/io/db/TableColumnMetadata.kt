 ...
 *   [java.sql.ResultSetMetaData.getColumnDisplaySize], or `0` when the driver does not report one.
 ...
 *   returns values of different classes. A custom [DbType] branching on it should treat `0` as
