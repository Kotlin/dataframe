...
/**
 * ### Write [<code>DataFrame</code>][org.jetbrains.kotlinx.dataframe.DataFrame] to TSV File
 *
 * Writes [this][this] [<code>DataFrame</code>][org.jetbrains.kotlinx.dataframe.DataFrame] to a TSV file.
 *
...
/**
 *
 * ### Write [<code>DataFrame</code>][org.jetbrains.kotlinx.dataframe.DataFrame] to TSV Appendable
 *
 * Writes [this][this] [<code>DataFrame</code>][org.jetbrains.kotlinx.dataframe.DataFrame] to a TSV [<code>Appendable</code>][Appendable].
 *
 * Parameters you can use to customize the process include, for instance, [delimiter],
 * [includeHeader], [quoteMode], and [headerComments].
 * See the param list below for all settings.
