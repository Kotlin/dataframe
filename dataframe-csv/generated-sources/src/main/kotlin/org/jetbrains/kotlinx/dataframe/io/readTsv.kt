 ...
 *
 * For example, [DataFrame.readTsv][readTsv]`("input.tsv")`
 *
 * or [DataFrame.readTsv][readTsv]`(`[File][File]`("input.tsv"))`
 *
 * ZIP (.zip) or GZIP (.gz) files are supported by default. [compression] is automatically detected.
 *
 * You can also read "raw" TSV data from a [String] using:
 *
 * [DataFrame.readTsvStr][readTsvStr]`("")`
 *
 ...
 * @param delimiter The field delimiter character. Default: 't'.
