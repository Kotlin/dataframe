 ...
 *
 * Writes [this] [DataFrame] to a delimiter-separated text file.
 *
 ...
 *
 * ##### Similar Functions
 * With overloads of [DataFrame.writeDelim][writeDelim]`()`, you can write delimiter-separated text to [File][File],
 ...
 *
 * Writes [this] [DataFrame] to a delimiter-separated text [Appendable].
 *
 * Parameters you can use to customize the process include, for instance, [delimiter],
 * [includeHeader], [quoteMode], and [headerComments].
 * See the param list below for all settings.
