...
/**
 * ### Write [<code>DataFrame</code>][org.jetbrains.kotlinx.dataframe.DataFrame] to Delimiter-Separated Text File
 *
 * Writes [this][this] [<code>DataFrame</code>][org.jetbrains.kotlinx.dataframe.DataFrame] to a delimiter-separated text file.
 *
...
/**
 *
 * ### Write [<code>DataFrame</code>][org.jetbrains.kotlinx.dataframe.DataFrame] to Delimiter-Separated Text Appendable
 *
 * Writes [this][this] [<code>DataFrame</code>][org.jetbrains.kotlinx.dataframe.DataFrame] to a delimiter-separated text [<code>Appendable</code>][Appendable].
 *
 * Parameters you can use to customize the process include, for instance, [delimiter],
 * [includeHeader], [quoteMode], and [headerComments].
 * See the param list below for all settings.
