...
private const val UPDATING_DATALORE_URL =
    "https://github.com/Kotlin/kotlin-jupyter/tree/master#datalore"
private const val UPDATING_KOTLIN_NOTEBOOK_URL =
    "https://github.com/Kotlin/kotlin-jupyter#kotlin-notebook"
...
internal fun getKernelUpdateMessage(
    ...
    append(
        "Your Kotlin Jupyter kernel version appears to be out of date (version $kernelVersion). "
    )
    appendLine(
        "Please update it to version $minKernelVersion or newer to be able to use DataFrame."
    )
