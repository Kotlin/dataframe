...
/**
 * Json to DataFrame converter that creates [<code>Any</code>][Any] columns.
 * A.k.a. [<code>TypeClashTactic.ANY_COLUMNS</code>][TypeClashTactic.ANY_COLUMNS].
 *
 * @param records List of json elements to be converted to a [<code>DataFrame</code>][DataFrame].
 * @param unifyNumbers Whether to [<code>unify the numbers that are read</code>][UnifyingNumbers].
 ...
 *     will be created.
 * @param header Optional list of column names. If given, [<code>records</code>][records] will be read like an object with [<code>header</code>][header] being the keys.
 * @return [DataFrame] from the given [<code>records</code>][records].
 */
...
/**
 * Collects the arrays of [<code>records</code>][records] into a single column named [<code>name</code>][name]: a `List` value column when the arrays
 * hold single values, else a [<code>FrameColumn</code>][FrameColumn] holding the objects of each array.
 *
 * @param parsed The contents of all arrays of [<code>records</code>][records], parsed and concatenated into one [<code>DataFrame</code>][DataFrame].
 * @param startIndices For each record, the index in [<code>parsed</code>][parsed] where its array starts, so that [<code>parsed</code>][parsed] can be
 ...
 * instead of [<code>Any</code>][Any] columns.
 * A.k.a. [<code>TypeClashTactic.ARRAY_AND_VALUE_COLUMNS</code>][TypeClashTactic.ARRAY_AND_VALUE_COLUMNS].
 *
 * @param records List of json elements to be converted to a [<code>DataFrame</code>][DataFrame].
 * @param unifyNumbers Whether to [<code>unify the numbers that are read</code>][UnifyingNumbers].
 * @param isLenient Whether to ignore malformed JSON elements and treat them as strings.
