...
class TemporaryDirectoryManagerImplFixed(testServices: TestServices) :
    ...
    private val rootTempDir = lazy {
        ...
        // This code will simplify directory name for windows. This is needed because there can
        // occur errors due to long name
    ...
    override fun getOrCreateTempDirectory(name: String): File =
        cache.getOrPut(name) { KtTestUtil.tmpDir(rootDir, name) }
    ...
    companion object {
        ...
        private fun String.getOnlyUpperCaseSymbols(): String =
            this.filter { it.isUpperCase() || it == '$' }.toList().joinToString(separator = "")
    }
}
