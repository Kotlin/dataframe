...
open class AbstractDataFrameBlackBoxCodegenTest : AbstractFirLightTreeBlackBoxCodegenTest() {
    ...
    override fun configure(builder: TestConfigurationBuilder) {
        ...
        builder.useAdditionalSourceProviders(::SourceProvider)
    }
    ...
    class SourceProvider(testServices: TestServices) : AdditionalSourceProvider(testServices) {
        companion object {
            const val COMMON_SOURCE_PATH = "testData/common.kt"
        }
