...
fun box(): String {
    ...
    val longRes: Long? = res21

    val res211 = personsDf.sum { age and weight }
    val doubleRes: Double? = res211
    ...
    val sum31: Int? = res0.age
    val sum32: Double? = res0.weight
    val sum33: Int? = res0.workExperienceYears
    val sum34: Int? = res0.dependentsCount
    val sum35: Long? = res0.annualIncome

    // scenario #4: sum of expression evaluated for every row
    val res4 = personsDf.sumOf { weight * 10 + age }
