...
* [**Import OpenAPI 3.0.0 Schemas in Gradle Project (Experimental)**](schemasImportOpenApiGradle.md) <br/>
  When you need to take data from the endpoint with OpenAPI Schema.

* [**Import Data Schemas, e.g. from OpenAPI 3.0.0, in Jupyter**](schemasImportOpenApiJupyter.md) <br/>
