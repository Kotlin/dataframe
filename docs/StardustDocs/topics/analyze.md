...
This operation [unions](multipleDataFrames.md#union) all groups of `GroupedDataFrame` into single `DataFrame`. It will result in original `DataFrame`, but with reordered rows according to grouping keys.
