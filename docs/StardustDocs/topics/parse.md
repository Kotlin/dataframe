...
* `nullStrings: List<String>` is used to treat particular strings as `null` value
    ...
    * When [reading from CSV](read.md), these are expanded to
      `["", "NA", "N/A", "null", "NULL", "None", "none", "NIL", "nil"]`.
...
For example, to change the locale to French and add a custom Java date-time pattern for all following DataFrame calls,
do:
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↪ `Locale.getDefault()`, which is the system's default locale that can
be changed with `Locale.setDefault()`.
...
<tabs>
<tab title="Kotlin">
<!---FUN globalParserOptionsAddDateTimeFormatKotlin-->
...
<tabs>
<tab title="Kotlin">
<!---FUN globalParserOptionsAddPatternKotlin-->
...
<tab title="Java">
<!---FUN globalParserOptionsAddPatternJava-->
...
<tabs>
<tab title="Kotlin">
<!---FUN parserOptionsWithDateTimeFormatKotlin-->
...
<tabs>
<tab title="Kotlin">
<!---FUN parserOptionsWithPatternKotlin-->
...
<tab title="Java">
<!---FUN parserOptionsWithPatternJava-->
...
Some functions, like [`convertToLocalDate()`](convert.md), take a `DateTimeFormat` or Unicode date-time pattern
directly.
