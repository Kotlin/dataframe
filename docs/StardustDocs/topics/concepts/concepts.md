...
* [**Interoperable**](collectionsInterop.md) — convertable with Kotlin data classes and collections.
  ...
  for some conversions between DataFrame and [Apache Spark](https://github.com/Kotlin/dataframe/tree/master/examples/projects/kotlin-spark), [Multik](https://github.com/Kotlin/dataframe/tree/master/examples/projects/multik), and [JetBrains Exposed](https://github.com/Kotlin/dataframe/tree/master/examples/projects/exposed).
