...
In Gradle project `Kotlin DataFrame` provides annotation processing for generatation of extension properties and gradle tasks to `DataSchema` inference from datasets.  
