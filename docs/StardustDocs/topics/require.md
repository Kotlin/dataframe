...
We recommend considering declaring a [DataSchema](dataSchema.md) and using [](cast.md) or [](convertTo.md) if you end up with more than a few `requireColumn` calls.
