...
<!---IMPORT org.jetbrains.kotlinx.dataframe.samples.io.H2-->
...
When working with an H2 database, the library automatically detects the compatibility mode from the connection.
